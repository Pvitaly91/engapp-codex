...
@section('title', 'Додати тег')

@section('content')
    <div class="py-8">
        <div class="mx-auto flex max-w-3xl flex-col gap-6">
            <div>
                <h1 class="text-3xl font-semibold text-slate-800">Новий тег</h1>
                <p class="text-slate-500">Створіть тег та за потреби одразу додайте нову категорію.</p>
            </div>
            ...
            <form method="POST" action="{{ route('test-tags.store') }}" class="space-y-5 rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
                @csrf
                <div class="space-y-2">
                ...
                <div class="grid gap-4 md:grid-cols-2">
                    <div class="space-y-2">
                        ...
                        <select
                            ...
                            class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm shadow-sm focus:border-blue-500 focus:outline-none focus:ring"
                        >
                            <option value="" @selected(old('category') === null || old('category') === '')>Без категорії</option>
                    ...
                    <div class="space-y-2">
                        ...
                        >
                        <p class="text-xs text-slate-400">Заповніть, якщо потрібно створити нову категорію.</p>
                    </div>
                </div>
