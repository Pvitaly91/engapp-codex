    ...
    <div class="py-8 space-y-6">
        <div class="max-w-5xl mx-auto space-y-6">
            <div class="space-y-2">
                ...
                <p class="text-slate-500">Додайте нові теги, редагуйте категорії або видаляйте зайві записи.</p>
            </div>
            ...
            <div class="grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.25fr)]">
                ...
                <div class="rounded-xl border border-slate-200 bg-white p-6 shadow-sm space-y-6">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-sm text-slate-400">Всього: {{ $tagsByCategory->flatten()->count() }}</span>
                    </div>
                    <div class="space-y-6">
