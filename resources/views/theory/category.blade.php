...
<div class="nd-page">
    ...
    <section class="relative overflow-hidden rounded-[12px] border p-7 shadow-card surface-card-strong" style="border-color: var(--line);">
        ...
        <div class="absolute bottom-0 right-0 hidden h-40 w-12 rounded-tl-[1.25rem] bg-amber lg:block"></div>
        <div class="relative flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            ...
            <div class="grid gap-3 sm:grid-cols-2">
                <div class="rounded-[10px] border px-5 py-4 surface-card" style="border-color: var(--line);">
                ...
                <a href="{{ localized_route($routePrefix . '.index') }}" class="rounded-[10px] bg-ocean px-5 py-4 text-sm font-extrabold uppercase tracking-[0.18em] text-white shadow-card transition hover:bg-[#245592]">
    ...
    <div class="mt-8 grid gap-8 lg:grid-cols-[320px_minmax(0,1fr)]">
        ...
        <div class="min-w-0 space-y-8">
            ...
            <section class="rounded-[12px] border p-6 shadow-card surface-card-strong" style="border-color: var(--line);">
                ...
                @if($categoryPages->isNotEmpty())
                    <div class="mt-8 grid gap-5 md:grid-cols-2">
                        @foreach($categoryPages as $page)
                            <a href="{{ localized_route($routePrefix . '.show', [$selectedCategory->slug, $page->slug]) }}" class="rounded-[10px] border p-5 shadow-card transition hover:-translate-y-1 surface-card" style="border-color: var(--line);">
                                <div class="flex items-center justify-between gap-4">
                                    <span class="inline-flex h-12 w-12 items-center justify-center rounded-[12px] bg-ocean text-sm font-extrabold text-white">
                ...
                @else
                    <div class="mt-8 rounded-[10px] border border-dashed p-8 text-center surface-card" style="border-color: var(--line);">
