...
<section class="space-y-5 rounded-[30px] border p-6 shadow-card surface-card-strong" style="border-color: var(--line);">
    <div class="rounded-[26px] border p-6 surface-card" style="border-color: var(--line);">
