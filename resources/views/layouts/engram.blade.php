                ...
                <div class="flex items-center justify-between gap-4 py-4">
                    <a href="{{ localized_route('home') }}" class="flex items-center gap-3" aria-label="Gramlyze">
                        ...
                        @if(config('app.is_beta'))
                            <span class="inline-flex items-center rounded-full bg-amber-100 dark:bg-amber-900/50 px-2.5 py-0.5 text-xs font-semibold text-amber-800 dark:text-amber-200 ring-1 ring-inset ring-amber-600/20 dark:ring-amber-400/30">{{ __('public.beta.badge') }}</span>
                        @endif
                    </a>
