...
<body class="font-sans antialiased selection:bg-primary/15 selection:text-primary">
  ...
  <script>
    // Localization object for JS strings
    window.i18n = {
      goToSlide: @json(__('public.slider.go_to_slide')),
      collapse: @json(__('public.common.collapse')),
      expand: @json(__('public.common.expand'))
    };
    ...
    function initSlider(slider) {
      ...
      if (dotsContainer) {
        ...
        items.forEach((_item, idx) => {
          ...
          dot.setAttribute('aria-label', `${window.i18n.goToSlide} ${idx + 1}`);
