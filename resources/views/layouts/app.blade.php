                ...
                <div class="hidden md:flex md:items-center md:gap-6 text-gray-600 font-medium">
                    ...
                    >
                        ...
                        >
                            ...
                            <a href="{{ route('artisan-commands.index') }}" class="block px-4 py-2 hover:bg-blue-50">Artisan команди</a>
                        </div>
                    </div>
            ...
            >
                ...
                <div x-data="{ openDeployment: false }" class="space-y-1">
                    ...
                    <div x-show="openDeployment" x-transition x-cloak class="ml-4 space-y-1 text-sm">
                        ...
                        <a href="{{ route('artisan-commands.index') }}" class="block rounded-lg px-2 py-1.5 hover:bg-blue-50">Artisan команди</a>
                    </div>
                </div>
