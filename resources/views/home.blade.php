...
<div class="space-y-24">
  ...
  <section
    ...
    class="relative overflow-hidden rounded-[2.5rem] border border-border/80 bg-gradient-to-br from-primary/10 via-background to-secondary/15 p-10 shadow-soft md:p-16"
  >
    ...
    <div class="relative grid gap-12 md:grid-cols-[1.35fr_1fr]">
      <div class="space-y-8" data-animate="fade-up" data-animate-delay="0.05">
        ...
        <dl class="grid gap-4 sm:grid-cols-3">
          @foreach ($heroHighlights as $item)
            <div
              class="group rounded-2xl border border-border/70 bg-background/80 p-4 backdrop-blur transition hover:-translate-y-1 hover:border-primary/50"
              data-animate="fade-up"
              data-animate-delay="{{ 0.25 + $loop->index * 0.07 }}"
            >
      ...
      <div
        class="space-y-6 rounded-3xl border border-border/60 bg-card/90 p-6 shadow-xl backdrop-blur"
        data-animate="fade-up"
        data-animate-delay="0.18"
      >
        <div class="space-y-3">
  ...
  <section id="solutions" class="space-y-8">
    ...
    <div class="flex snap-x snap-mandatory gap-6 overflow-x-auto pb-6 hide-scrollbar md:grid md:grid-cols-2 md:gap-6 md:overflow-visible md:pb-0">
      @foreach ($productMap as $card)
        <article
          class="group relative flex h-full min-w-[85%] snap-center flex-col justify-between overflow-hidden rounded-3xl border border-border/70 bg-card p-8 shadow-soft transition hover:-translate-y-2 hover:border-{{ $card['accent'] }}/60 hover:shadow-xl md:min-w-0"
          data-animate="fade-up"
          data-animate-delay="{{ 0.1 + $loop->index * 0.12 }}"
        >
  ...
  <section id="metrics" class="space-y-8">
    ...
    <dl class="flex snap-x snap-mandatory gap-4 overflow-x-auto pb-6 hide-scrollbar sm:grid sm:grid-cols-2 sm:gap-6 sm:overflow-visible sm:pb-0 lg:grid-cols-4">
      @foreach ($statLabels as $key => $meta)
        <div
          class="group relative min-w-[70%] snap-center overflow-hidden rounded-3xl border border-border/70 bg-card p-6 shadow-soft transition hover:-translate-y-2 hover:shadow-xl sm:min-w-0"
          data-animate="fade-up"
          data-animate-delay="{{ 0.1 + $loop->index * 0.1 }}"
        >
  ...
  <section id="workflow" class="space-y-8">
    ...
    <ol class="flex snap-x snap-mandatory gap-6 overflow-x-auto pb-6 hide-scrollbar md:grid md:grid-cols-2 md:gap-6 md:overflow-visible md:pb-0">
      @foreach ($workflow as $item)
        <li
          class="group relative min-w-[85%] snap-center overflow-hidden rounded-3xl border border-border/70 bg-card p-6 shadow-soft transition hover:-translate-y-2 hover:border-primary/60 hover:shadow-xl md:min-w-0"
          data-animate="fade-up"
          data-animate-delay="{{ 0.1 + $loop->index * 0.12 }}"
        >
  ...
  <section
    id="ai-toolkit"
    class="overflow-hidden rounded-[2.5rem] border border-border/80 bg-gradient-to-br from-background via-primary/5 to-secondary/10 p-10 shadow-soft md:p-16"
    data-animate="fade-up"
  >
    <div class="space-y-8">
      <div class="space-y-2" data-animate="fade" data-animate-delay="0.05">
      ...
      <div class="flex snap-x snap-mandatory gap-6 overflow-x-auto pb-6 hide-scrollbar md:grid md:grid-cols-2 md:gap-6 md:overflow-visible md:pb-0">
        @foreach ($aiToolkit as $tool)
          <article
            class="group relative min-w-[80%] snap-center overflow-hidden rounded-3xl border border-border/70 bg-card p-6 shadow-soft transition hover:-translate-y-2 hover:border-primary/60 hover:shadow-xl md:min-w-0"
            data-animate="fade-up"
            data-animate-delay="{{ 0.12 + $loop->index * 0.1 }}"
          >
  ...
  <section id="team-collaboration" class="space-y-8">
    <div class="space-y-2" data-animate="fade-up" data-animate-delay="0.05">
    ...
    <div class="flex snap-x snap-mandatory gap-6 overflow-x-auto pb-6 hide-scrollbar md:grid md:grid-cols-3 md:gap-6 md:overflow-visible md:pb-0">
      @foreach ($teamUseCases as $case)
        <article
          class="min-w-[80%] snap-center rounded-3xl border border-border/70 bg-card p-6 shadow-soft md:min-w-0"
          data-animate="fade-up"
          data-animate-delay="{{ 0.1 + $loop->index * 0.12 }}"
        >
  ...
  <!-- CTA -->
  <section
    class="overflow-hidden rounded-[2.5rem] border border-border/80 bg-gradient-to-br from-primary via-primary/80 to-secondary p-10 text-primary-foreground shadow-soft md:p-16"
    data-animate="scale-in"
  >
    <div class="grid gap-10 md:grid-cols-[1.5fr_1fr] md:items-center">
      <div class="space-y-6" data-animate="fade" data-animate-delay="0.05">
      ...
      <div class="space-y-4 rounded-3xl border border-primary-foreground/40 bg-primary-foreground/10 p-6 text-sm text-primary-foreground" data-animate="fade-up" data-animate-delay="0.18">
