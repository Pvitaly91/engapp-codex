...
<div class="space-y-24">
  <!-- HERO -->
  <section id="hero" data-animate="fade-in" class="relative overflow-hidden rounded-[2.5rem] border border-border/80 bg-gradient-to-br from-primary/10 via-background to-secondary/15 p-10 shadow-soft md:p-16">
    ...
    <div class="relative grid gap-12 md:grid-cols-[1.35fr_1fr]">
      <div class="space-y-8" data-animate data-animate-delay="40">
        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center" data-animate data-animate-delay="100">
        ...
        <dl class="grid gap-4 sm:grid-cols-3">
          @foreach ($heroHighlights as $item)
            <div data-animate data-animate-delay="{{ $loop->iteration * 120 }}" class="group rounded-2xl border border-border/70 bg-background/80 p-4 backdrop-blur transition hover:-translate-y-1 hover:border-primary/50">
      ...
      <div data-animate data-animate-delay="200" class="space-y-6 rounded-3xl border border-border/60 bg-card/90 p-6 shadow-xl backdrop-blur">
        <div class="space-y-3">
  ...
  @endphp
  <section id="solutions" data-animate class="space-y-8">
    ...
    <div class="flex justify-end gap-2 md:hidden" data-animate data-animate-delay="50">
      <button type="button" data-slider-prev="slider-product-map" aria-controls="slider-product-map" class="inline-flex h-10 w-10 items-center justify-center rounded-full border border-border bg-background text-foreground shadow-sm transition hover:border-primary hover:text-primary disabled:opacity-50 disabled:shadow-none" aria-label="Попередній слайд">
        <span aria-hidden="true">&#8592;</span>
      </button>
      <button type="button" data-slider-next="slider-product-map" aria-controls="slider-product-map" class="inline-flex h-10 w-10 items-center justify-center rounded-full border border-border bg-background text-foreground shadow-sm transition hover:border-primary hover:text-primary disabled:opacity-50 disabled:shadow-none" aria-label="Наступний слайд">
        <span aria-hidden="true">&#8594;</span>
      </button>
    </div>
    <div id="slider-product-map" data-mobile-slider class="mobile-slider -mx-4 flex snap-x snap-mandatory gap-4 overflow-x-auto px-4 pb-4 md:mx-0 md:grid md:grid-cols-2 md:gap-6 md:overflow-visible md:px-0 md:pb-0 md:[scroll-snap-type:none]">
      @foreach ($productMap as $card)
        <article data-animate data-animate-delay="{{ $loop->index * 120 }}" class="group relative flex h-full min-w-[85%] flex-col justify-between overflow-hidden rounded-3xl border border-border/70 bg-card p-8 shadow-soft transition hover:-translate-y-2 hover:border-{{ $card['accent'] }}/60 hover:shadow-xl md:min-w-0 md:snap-align-none snap-center">
  ...
  @endphp
  <section id="metrics" data-animate class="space-y-8">
    <div class="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
      <div class="space-y-2">
    ...
    <div class="flex justify-end gap-2 md:hidden" data-animate data-animate-delay="60">
      <button type="button" data-slider-prev="slider-metrics" aria-controls="slider-metrics" class="inline-flex h-10 w-10 items-center justify-center rounded-full border border-border bg-background text-foreground shadow-sm transition hover:border-primary hover:text-primary disabled:opacity-50 disabled:shadow-none" aria-label="Попередній показник">
        <span aria-hidden="true">&#8592;</span>
      </button>
      <button type="button" data-slider-next="slider-metrics" aria-controls="slider-metrics" class="inline-flex h-10 w-10 items-center justify-center rounded-full border border-border bg-background text-foreground shadow-sm transition hover:border-primary hover:text-primary disabled:opacity-50 disabled:shadow-none" aria-label="Наступний показник">
        <span aria-hidden="true">&#8594;</span>
      </button>
    </div>
    <dl id="slider-metrics" data-mobile-slider class="mobile-slider -mx-4 flex snap-x snap-mandatory gap-4 overflow-x-auto px-4 pb-4 sm:gap-5 md:mx-0 md:grid md:grid-cols-2 md:gap-6 md:overflow-visible md:px-0 md:pb-0 md:[scroll-snap-type:none] lg:grid-cols-4">
      @foreach ($statLabels as $key => $meta)
        <div data-animate data-animate-delay="{{ $loop->index * 120 }}" class="group relative min-w-[70%] overflow-hidden rounded-3xl border border-border/70 bg-card p-6 shadow-soft transition hover:-translate-y-2 hover:shadow-xl md:min-w-0 snap-center md:snap-align-none">
  ...
  @endphp
  <section id="workflow" data-animate class="space-y-8">
    <div class="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
      <div class="space-y-2">
    ...
    <div class="flex justify-end gap-2 md:hidden" data-animate data-animate-delay="40">
      <button type="button" data-slider-prev="slider-workflow" aria-controls="slider-workflow" class="inline-flex h-10 w-10 items-center justify-center rounded-full border border-border bg-background text-foreground shadow-sm transition hover:border-primary hover:text-primary disabled:opacity-50 disabled:shadow-none" aria-label="Попередній крок">
        <span aria-hidden="true">&#8592;</span>
      </button>
      <button type="button" data-slider-next="slider-workflow" aria-controls="slider-workflow" class="inline-flex h-10 w-10 items-center justify-center rounded-full border border-border bg-background text-foreground shadow-sm transition hover:border-primary hover:text-primary disabled:opacity-50 disabled:shadow-none" aria-label="Наступний крок">
        <span aria-hidden="true">&#8594;</span>
      </button>
    </div>
    <ol id="slider-workflow" data-mobile-slider class="mobile-slider -mx-4 flex snap-x snap-mandatory gap-4 overflow-x-auto px-4 pb-4 md:mx-0 md:grid md:grid-cols-2 md:gap-6 md:overflow-visible md:px-0 md:pb-0 md:[scroll-snap-type:none]">
      @foreach ($workflow as $item)
        <li data-animate data-animate-delay="{{ $loop->index * 120 }}" class="group relative min-w-[80%] overflow-hidden rounded-3xl border border-border/70 bg-card p-6 shadow-soft transition hover:-translate-y-2 hover:border-primary/60 hover:shadow-xl snap-center md:min-w-0 md:snap-align-none">
  ...
  @endphp
  <section id="ai-toolkit" data-animate class="overflow-hidden rounded-[2.5rem] border border-border/80 bg-gradient-to-br from-background via-primary/5 to-secondary/10 p-10 shadow-soft md:p-16">
    <div class="space-y-8">
      <div class="space-y-2">
      ...
      <div class="flex justify-end gap-2 md:hidden" data-animate data-animate-delay="40">
        <button type="button" data-slider-prev="slider-ai" aria-controls="slider-ai" class="inline-flex h-10 w-10 items-center justify-center rounded-full border border-border bg-background text-foreground shadow-sm transition hover:border-primary hover:text-primary disabled:opacity-50 disabled:shadow-none" aria-label="Попередній інструмент">
          <span aria-hidden="true">&#8592;</span>
        </button>
        <button type="button" data-slider-next="slider-ai" aria-controls="slider-ai" class="inline-flex h-10 w-10 items-center justify-center rounded-full border border-border bg-background text-foreground shadow-sm transition hover:border-primary hover:text-primary disabled:opacity-50 disabled:shadow-none" aria-label="Наступний інструмент">
          <span aria-hidden="true">&#8594;</span>
        </button>
      </div>
      <div id="slider-ai" data-mobile-slider class="mobile-slider -mx-4 flex snap-x snap-mandatory gap-4 overflow-x-auto px-4 pb-4 md:mx-0 md:grid md:grid-cols-2 md:gap-6 md:overflow-visible md:px-0 md:pb-0 md:[scroll-snap-type:none]">
        @foreach ($aiToolkit as $tool)
          <article data-animate data-animate-delay="{{ $loop->index * 120 }}" class="group relative min-w-[80%] overflow-hidden rounded-3xl border border-border/70 bg-card p-6 shadow-soft transition hover:-translate-y-2 hover:border-primary/60 hover:shadow-xl snap-center md:min-w-0 md:snap-align-none">
  ...
  @endphp
  <section id="team-collaboration" data-animate class="space-y-8">
    <div class="space-y-2">
    ...
    <div class="flex justify-end gap-2 md:hidden" data-animate data-animate-delay="40">
      <button type="button" data-slider-prev="slider-team" aria-controls="slider-team" class="inline-flex h-10 w-10 items-center justify-center rounded-full border border-border bg-background text-foreground shadow-sm transition hover:border-primary hover:text-primary disabled:opacity-50 disabled:shadow-none" aria-label="Попередній сценарій">
        <span aria-hidden="true">&#8592;</span>
      </button>
      <button type="button" data-slider-next="slider-team" aria-controls="slider-team" class="inline-flex h-10 w-10 items-center justify-center rounded-full border border-border bg-background text-foreground shadow-sm transition hover:border-primary hover:text-primary disabled:opacity-50 disabled:shadow-none" aria-label="Наступний сценарій">
        <span aria-hidden="true">&#8594;</span>
      </button>
    </div>
    <div id="slider-team" data-mobile-slider class="mobile-slider -mx-4 flex snap-x snap-mandatory gap-4 overflow-x-auto px-4 pb-4 md:mx-0 md:grid md:grid-cols-3 md:gap-6 md:overflow-visible md:px-0 md:pb-0 md:[scroll-snap-type:none]">
      @foreach ($teamUseCases as $case)
        <article data-animate data-animate-delay="{{ $loop->index * 140 }}" class="min-w-[80%] rounded-3xl border border-border/70 bg-card p-6 shadow-soft snap-center md:min-w-0 md:snap-align-none">
  ...
  <!-- CTA -->
  <section data-animate="fade-in" class="overflow-hidden rounded-[2.5rem] border border-border/80 bg-gradient-to-br from-primary via-primary/80 to-secondary p-10 text-primary-foreground shadow-soft md:p-16">
    <div class="grid gap-10 md:grid-cols-[1.5fr_1fr] md:items-center">
      <div class="space-y-6" data-animate data-animate-delay="60">
        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
          <a href="mailto:team@gramlyze.com" class="inline-flex items-center justify-center gap-2 rounded-2xl bg-background px-6 py-3 text-sm font-semibold text-foreground transition hover:bg-background/80">
            Залишити запит на підключення
            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
            </svg>
          </a>
      ...
      <div data-animate data-animate-delay="140" class="space-y-4 rounded-3xl border border-primary-foreground/40 bg-primary-foreground/10 p-6 text-sm text-primary-foreground">
