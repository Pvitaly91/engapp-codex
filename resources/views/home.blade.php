...
@php
    ...
    $pathCards = [
        ...
        [
            'href' => localized_route('courses.show', 'polyglot-english-b1'),
            'eyebrow' => __('public.nav.polyglot_course'),
        ...
        [
            'href' => localized_route('courses.show', 'polyglot-english-b2'),
            'eyebrow' => __('public.nav.polyglot_course'),
            'title' => __('public.home.polyglot_b2_title'),
            'description' => __('public.home.polyglot_b2_desc'),
            'badge' => '08',
            'accent' => 'bg-cyan-600',
            'icon' => 'B2',
        ],
        [
            'href' => localized_route('courses.show', 'polyglot-english-c1'),
            'eyebrow' => __('public.nav.polyglot_course'),
            'title' => __('public.home.polyglot_c1_title'),
            'description' => __('public.home.polyglot_c1_desc'),
            'badge' => '09',
            'accent' => 'bg-indigo-600',
            'icon' => 'C1',
        ],
        [
            'href' => localized_route('courses.show', 'polyglot-english-c2'),
            'eyebrow' => __('public.nav.polyglot_course'),
            'title' => __('public.home.polyglot_c2_title'),
            'description' => __('public.home.polyglot_c2_desc'),
            'badge' => '10',
