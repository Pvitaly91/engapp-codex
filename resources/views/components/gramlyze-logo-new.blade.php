...
@if ($variant === 'icon')
    ...
    <span {{ $attributes->class("inline-flex {$size} items-center justify-center rounded-lg bg-gradient-to-tr from-emerald-500 via-teal-600 to-cyan-600 text-white shadow-md") }}>
