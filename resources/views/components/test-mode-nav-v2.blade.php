        ...
        <div class="flex flex-col gap-4 p-4 md:flex-row md:items-center md:justify-between md:gap-6 lg:p-6">
            <div class="flex flex-1 flex-col gap-2 md:flex-row md:items-center md:gap-3">
                <span class="flex items-center text-sm font-semibold text-slate-600">
                    ...
                    <span class="ml-2">{{ __('frontend.tests.mode.view') }}</span>
                </span>
                <div class="flex flex-wrap gap-2">
                    <a href="{{ localized_route('test.show', $test->slug) }}"
                    ...
                    <a href="{{ localized_route('test.step', $test->slug) }}"
                       class="inline-flex items-center rounded-full border px-4 py-2 text-sm font-semibold transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 {{ \Illuminate\Support\Str::contains(request()->path(), 'step') ? 'border-indigo-200 bg-indigo-500 text-white shadow-sm hover:bg-indigo-600 hover:border-indigo-300' : 'border-slate-200 bg-white text-slate-700 hover:-translate-y-0.5 hover:border-indigo-200 hover:bg-indigo-50 hover:text-indigo-700' }}">
            ...
            <div class="flex flex-1 flex-col gap-2 md:flex-row md:items-center md:gap-3">
                <span class="flex items-center text-sm font-semibold text-slate-600">
                    ...
                    <span class="ml-2">{{ __('frontend.tests.mode.difficulty') }}</span>
                </span>
                <div class="flex flex-wrap gap-2">
                    @if (\Illuminate\Support\Str::contains(request()->path(), 'step'))
                        <a href="{{ localized_route('test.step', $test->slug) }}" class="inline-flex items-center rounded-full border px-4 py-2 text-sm font-semibold transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-500 {{ request()->routeIs('test.step') ? 'border-emerald-200 bg-emerald-500 text-white shadow-sm hover:bg-emerald-600 hover:border-emerald-300' : 'border-slate-200 bg-white text-slate-700 hover:-translate-y-0.5 hover:border-emerald-200 hover:bg-emerald-50 hover:text-emerald-700' }}">{{ __('frontend.tests.mode.easy') }}</a>
                        <a href="{{ localized_route('test.step-select', $test->slug) }}" class="inline-flex items-center rounded-full border px-4 py-2 text-sm font-semibold transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-500 {{ request()->routeIs('test.step-select') ? 'border-emerald-200 bg-emerald-500 text-white shadow-sm hover:bg-emerald-600 hover:border-emerald-300' : 'border-slate-200 bg-white text-slate-700 hover:-translate-y-0.5 hover:border-emerald-200 hover:bg-emerald-50 hover:text-emerald-700' }}">{{ __('frontend.tests.mode.medium') }}</a>
                        <a href="{{ localized_route('test.step-input', $test->slug) }}" class="inline-flex items-center rounded-full border px-4 py-2 text-sm font-semibold transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-500 {{ request()->routeIs('test.step-input') ? 'border-emerald-200 bg-emerald-500 text-white shadow-sm hover:bg-emerald-600 hover:border-emerald-300' : 'border-slate-200 bg-white text-slate-700 hover:-translate-y-0.5 hover:border-emerald-200 hover:bg-emerald-50 hover:text-emerald-700' }}">{{ __('frontend.tests.mode.hard') }}</a>
                        <a href="{{ localized_route('test.step-manual', $test->slug) }}" class="inline-flex items-center rounded-full border px-4 py-2 text-sm font-semibold transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-500 {{ request()->routeIs('test.step-manual') ? 'border-emerald-200 bg-emerald-500 text-white shadow-sm hover:bg-emerald-600 hover:border-emerald-300' : 'border-slate-200 bg-white text-slate-700 hover:-translate-y-0.5 hover:border-emerald-200 hover:bg-emerald-50 hover:text-emerald-700' }}">{{ __('frontend.tests.mode.expert') }}</a>
                    @else
                        <a href="{{ localized_route('test.show', $test->slug) }}" class="inline-flex items-center rounded-full border px-4 py-2 text-sm font-semibold transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-500 {{ request()->routeIs('test.show') ? 'border-emerald-200 bg-emerald-500 text-white shadow-sm hover:bg-emerald-600 hover:border-emerald-300' : 'border-slate-200 bg-white text-slate-700 hover:-translate-y-0.5 hover:border-emerald-200 hover:bg-emerald-50 hover:text-emerald-700' }}">{{ __('frontend.tests.mode.easy') }}</a>
                        <a href="{{ localized_route('test.select', $test->slug) }}" class="inline-flex items-center rounded-full border px-4 py-2 text-sm font-semibold transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-500 {{ request()->routeIs('test.select') ? 'border-emerald-200 bg-emerald-500 text-white shadow-sm hover:bg-emerald-600 hover:border-emerald-300' : 'border-slate-200 bg-white text-slate-700 hover:-translate-y-0.5 hover:border-emerald-200 hover:bg-emerald-50 hover:text-emerald-700' }}">{{ __('frontend.tests.mode.medium') }}</a>
                        <a href="{{ localized_route('test.input', $test->slug) }}" class="inline-flex items-center rounded-full border px-4 py-2 text-sm font-semibold transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-500 {{ request()->routeIs('test.input') ? 'border-emerald-200 bg-emerald-500 text-white shadow-sm hover:bg-emerald-600 hover:border-emerald-300' : 'border-slate-200 bg-white text-slate-700 hover:-translate-y-0.5 hover:border-emerald-200 hover:bg-emerald-50 hover:text-emerald-700' }}">{{ __('frontend.tests.mode.hard') }}</a>
                        <a href="{{ localized_route('test.manual', $test->slug) }}" class="inline-flex items-center rounded-full border px-4 py-2 text-sm font-semibold transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-500 {{ request()->routeIs('test.manual') ? 'border-emerald-200 bg-emerald-500 text-white shadow-sm hover:bg-emerald-600 hover:border-emerald-300' : 'border-slate-200 bg-white text-slate-700 hover:-translate-y-0.5 hover:border-emerald-200 hover:bg-emerald-50 hover:text-emerald-700' }}">{{ __('frontend.tests.mode.expert') }}</a>
                    @endif
                </div>
            </div>
            ...
            <div class="flex flex-1 flex-col gap-2 md:flex-row md:items-center md:justify-end md:gap-3">
                <span class="flex items-center text-sm font-semibold text-slate-600">
                    ...
                    <span class="ml-2">{{ __('frontend.tests.mode.games') }}</span>
                </span>
                <div class="flex flex-wrap gap-2">
                    <a href="{{ localized_route('test.drag-drop', $test->slug) }}" class="inline-flex items-center rounded-full border px-4 py-2 text-sm font-semibold transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-500 {{ request()->routeIs('test.drag-drop') ? 'border-rose-200 bg-rose-500 text-white shadow-sm hover:bg-rose-600 hover:border-rose-300' : 'border-slate-200 bg-white text-slate-700 hover:-translate-y-0.5 hover:border-rose-200 hover:bg-rose-50 hover:text-rose-700' }}">{{ __('frontend.tests.mode.drag_drop') }}</a>
                    <a href="{{ localized_route('test.match', $test->slug) }}" class="inline-flex items-center rounded-full border px-4 py-2 text-sm font-semibold transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-500 {{ request()->routeIs('test.match') ? 'border-rose-200 bg-rose-500 text-white shadow-sm hover:bg-rose-600 hover:border-rose-300' : 'border-slate-200 bg-white text-slate-700 hover:-translate-y-0.5 hover:border-rose-200 hover:bg-rose-50 hover:text-rose-700' }}">{{ __('frontend.tests.mode.match') }}</a>
                    <a href="{{ localized_route('test.dialogue', $test->slug) }}" class="inline-flex items-center rounded-full border px-4 py-2 text-sm font-semibold transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-500 {{ request()->routeIs('test.dialogue') ? 'border-rose-200 bg-rose-500 text-white shadow-sm hover:bg-rose-600 hover:border-rose-300' : 'border-slate-200 bg-white text-slate-700 hover:-translate-y-0.5 hover:border-rose-200 hover:bg-rose-50 hover:text-rose-700' }}">{{ __('frontend.tests.mode.dialogue') }}</a>
                </div>
            </div>
        </div>
    </div>
