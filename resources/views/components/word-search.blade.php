<div x-data="wordSearch()" @click.outside="close()" class="relative z-50 space-y-1.5 sm:space-y-2" data-word-search-root>
    ...
    <div class="relative">
        ...
        <div x-show="open && results.length" x-cloak x-transition class="absolute left-0 right-0 z-[9999] mt-2 rounded-2xl border border-gray-200 bg-white shadow-xl" data-word-search-results>
