{{--
    New-Design – Nested category navigation for mobile flyout menu
        ...
        <div class="flex items-center" style="padding-left: {{ $indent }}px">
            @if($isExpandable)
                <button
                    ...
                    class="flex h-7 w-7 items-center justify-center rounded text-[var(--nd-muted)] hover:text-[var(--nd-ocean)] hover:bg-ocean/8 transition-colors flex-shrink-0"
                    type="button"
                >
            ...
            <a
                ...
                class="flex-1 flex items-center justify-between rounded-xl px-2 py-2 text-sm
                    {{ $isActive
            ...
            <div x-show="expanded" x-collapse>
                @foreach($orderedItems as $item)
                    ...
                    @else
                        ...
                        <div style="padding-left: {{ $indent + 28 }}px">
                            <a
                            ...
                            >
                                ...
                                <span class="line-clamp-2 break-words">{{ $pageItem->title }}</span>
                            </a>
                        </div>
                    @endif
                @endforeach
