...
<div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
    @foreach($pages as $page)
        <a href="{{ $categorySlug ? route(($routePrefix ?? 'pages') . '.show', [$categorySlug, $page->slug]) : '#' }}" class="block p-4 bg-card text-card-foreground rounded-xl shadow-soft hover:bg-muted">
