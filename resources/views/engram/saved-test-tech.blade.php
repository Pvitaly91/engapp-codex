...
@php
    ...
    $primaryJsRoute = match ($preferredView) {
        'drag-drop' => route('saved-test.js.drag-drop', $test->slug),
        'match' => route('saved-test.js.match', $test->slug),
        default => route('saved-test.js', $test->slug),
    };
@endphp
...
<script>
    (() => {
        ...
        const routes = {
            ...
            question: '{{ url('/admin/questions') }}',
            answer: '{{ url('/admin/question-answers') }}',
            variant: '{{ url('/admin/question-variants') }}',
            option: '{{ url('/admin/questions') }}',
            questionHint: '{{ url('/admin/question-hints') }}',
            verbHint: '{{ url('/admin/verb-hints') }}',
            chatgptExplanation: '{{ url('/admin/chatgpt-explanations') }}',
            deleteQuestion: '{{ url('/admin/test/' . $test->slug . '/question') }}',
