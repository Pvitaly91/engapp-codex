<div class="space-y-8">
  ...
  {{-- Loading Overlay (shows only for submitAnswer/resetTest actions after 1.5 seconds) --}}
  <div wire:loading.flex.delay.longest wire:target="submitAnswer, resetTest" class="fixed inset-0 z-50 bg-black/20 backdrop-blur-sm items-center justify-center">
