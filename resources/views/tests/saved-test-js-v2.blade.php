...
function renderQuestions(showOnlyWrong = false) {
  ...
  state.items.forEach((q, idx) => {
    ...
    card.className = 'group bg-white rounded-none sm:rounded-3xl shadow-md hover:shadow-xl border-y border-gray-100 sm:border-2 hover:border-indigo-200 p-5 sm:p-8 transition-all duration-300 focus-within:ring-4 ring-indigo-100 outline-none transform hover:-translate-y-1 -mx-4 sm:mx-0';
    card.tabIndex = 0;
