...
return [
    ...
    'feedback_error_msg' => 'Pay attention to the correct answer and try again.',

    // Completion
    'test_completed' => 'Test Completed',
    'all_words_done' => 'All available words have been processed',
    'can_restart' => 'You can start over to review the material.',

    // Failure
    'test_failed' => 'Test Failed',
    'error_limit' => 'Exceeded the limit of 3 errors',
    'error_limit_msg' => 'You made three errors in a row. Click "Try Again" to retake the test.',

    // Empty state
    'no_questions' => 'No questions found',
    'no_questions_msg' => 'Add more words with translations in the active language or click "Start Over" to try again.',
    'all_done' => 'All done',
