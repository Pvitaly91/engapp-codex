...
return [
    ...
    'courses' => [
        ...
        'theory_driven_course_description' => 'A course that uses existing theory pages as the syllabus and mixed V3 / Polyglot content for practice.',
        'theory_driven_course_catalog_hint' => 'Opens the existing /courses/theory-driven runtime with course-td-* lessons and the Polyglot unlock flow.',
