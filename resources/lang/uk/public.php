...
return [
    ...
    'beta' => [
        ...
        'banner_note' => 'Дякуємо за терпіння та фідбек.',
    ],

    'coming_soon' => [
        'meta_title' => 'Скоро буде доступно — Gramlyze',
        'kicker' => 'У розробці',
        'title' => 'Скоро буде доступно',
        'text' => 'Розділ у розробці. Спробуйте пізніше.',
        'home' => 'На головну',
        'back' => 'Назад',
        'contact_hint' => 'Якщо помітили баг — напишіть нам.',
    ],

    'errors' => [
        'meta_title' => 'Помилка :code — Gramlyze',
        'kicker' => 'Сторінка помилки',
        'home' => 'На головну',
        'back' => 'Повернутись назад',
        'search_label' => 'Пошук',
        '403' => [
            'title' => 'Доступ заборонено',
            'text' => 'У вас немає прав для перегляду цієї сторінки.',
        ],
        '404' => [
            'title' => 'Сторінку не знайдено',
            'text' => 'Можливо, сторінка була видалена або ви ввели неправильну адресу.',
        ],
        '419' => [
            'title' => 'Сесія завершилась',
            'text' => 'Термін дії сторінки закінчився. Спробуйте оновити та повторити.',
        ],
        '429' => [
            'title' => 'Забагато запитів',
            'text' => 'Ви надсилаєте запити занадто часто. Спробуйте пізніше.',
        ],
        '500' => [
            'title' => 'Помилка сервера',
            'text' => 'Щось пішло не так на нашому боці.',
        ],
        '503' => [
            'title' => 'Сервіс тимчасово недоступний',
            'text' => 'Ми вже працюємо над цим. Спробуйте пізніше.',
        ],
        '4xx' => [
            'title' => 'Помилка запиту',
            'text' => 'Схоже, виникла проблема з вашим запитом.',
        ],
        '5xx' => [
            'title' => 'Тимчасова помилка сервера',
            'text' => 'Сервер тимчасово недоступний. Спробуйте пізніше.',
        ],
    ],
