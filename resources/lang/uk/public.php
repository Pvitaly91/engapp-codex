...
return [
    ...
    'meta' => [
        ...
        'description' => 'Вивчайте англійську граматику на Gramlyze: структурована теорія, інтерактивні тести, курси, практика слів і неправильних дієслів.',
    ],
    ...
    'pages' => [
        'title' => 'Теорія',
        'meta_description' => 'Переглядайте матеріали Gramlyze за категоріями: правила англійської граматики, приклади, пояснення та практичні вправи.',
    ...
    'theory' => [
        ...
        'seo' => [
            ...
            'index_description' => 'Оберіть тему англійської граматики: будова речення, часи, пасивний стан, умовні речення та інші розділи з поясненнями й прикладами.',
    ...
    'tests' => [
        'meta_description' => ':test — інтерактивний тест англійської на Gramlyze. Перевірте знання, виконайте вправи та отримайте результат.',
    ],

    // Courses section
    'courses' => [
        'title' => 'Курси англійської граматики та побудови речень | Gramlyze',
        'meta_description' => 'Напрями навчання на Gramlyze: English Sentence Builder, курс граматичної теорії та курс за темами теорії зі змішаними тестами.',
        'course_meta_description' => ':course — структурований курс англійської на Gramlyze з уроками, практичними вправами та відстеженням прогресу.',
        'breadcrumb' => 'Курси',
    ...
    // Home page
    'home' => [
        'title' => 'Англійська граматика: теорія, тести й курси | Gramlyze',
    ...
    'background' => [
        'blue' => 'Увімкнути синій фон',
        'cards' => 'Увімкнути фон у кольорах карток',
        'custom' => 'Увімкнути власний фон',
        'widget' => 'Налаштувати фон',
        'title' => 'Фон сайту',
        'description' => 'Оберіть режим або задайте кольори вручну.',
        'blue_short' => 'Синій',
        'cards_short' => 'Картки',
        'custom_short' => 'Вручну',
        'ct' => 'Колір CT',
