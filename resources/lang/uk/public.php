...
return [
    ...
    'courses' => [
        ...
        'theory_driven_course_description' => 'Курс, що використовує існуючі сторінки теорії як програму та змішані тести з наявного контенту V3 / Polyglot.',
        'theory_driven_course_catalog_hint' => 'Відкриває існуючий runtime /courses/theory-driven з lesson slug course-td-* та Polyglot unlock flow.',
