            ...
            [
                ...
                'parts' => [
                    ...
                    'a2' => [
                        ...
                        'concept' => 'external_obligation',
                        'example_hint' => 'Наприклад: Обов\'язок переглядати код.',
                    ],
                ],
            ],
            [
            ...
            [
                ...
                'parts' => [
                    ...
                    'a2' => [
                        ...
                        'concept' => 'personal_duty',
                        'example_hint' => 'Наприклад: Рекомендація повідомляти про порушення.',
                    ],
                ],
            ],
            ...
            [
                ...
                'parts' => [
                    ...
                    'a2' => [
                        'options' => ['should', 'can', 'must', 'may'],
                        'answer_index' => 0,
                        'verb_hint' => 'audit recommendation',
                        'concept' => 'personal_duty',
                        'example_hint' => 'Наприклад: Рекомендовані перевірки.',
                    ],
                ],
            ],
            [
            ...
            [
                ...
                'parts' => [
                    ...
                    'a2' => [
                        'options' => ['should', 'can', 'must', 'may'],
                        'answer_index' => 0,
                        'verb_hint' => 'custody recommendation',
                        'concept' => 'personal_duty',
                        'example_hint' => 'Наприклад: Рекомендація зберігати ланцюг.',
                    ],
                ],
            ],
            [
            ...
            [
                ...
                'parts' => [
                    ...
                    'a2' => [
                        'options' => ['should', 'can', 'must', 'may'],
                        'answer_index' => 0,
                        'verb_hint' => 'external influence avoidance',
                        'concept' => 'personal_duty',
                        'example_hint' => 'Наприклад: Рекомендація ігнорувати вплив.',
                    ],
                ],
            ],
            [
            ...
            [
                ...
                'parts' => [
                    ...
                    'a2' => [
                        'options' => ['should', 'can', 'must', 'may'],
                        'answer_index' => 0,
                        'verb_hint' => 'transparency expectation',
                        'concept' => 'personal_duty',
                        'example_hint' => 'Наприклад: Рекомендація розкривати комунікації.',
                    ],
                ],
            ],
            [
