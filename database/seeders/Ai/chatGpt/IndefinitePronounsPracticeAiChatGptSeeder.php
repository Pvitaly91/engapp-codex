        ...
        $levels = [
            ...
            'C2' => [
                'negative' => [
                    ...
                    ['question' => 'The committee scarcely acknowledged {a1} of the warnings, so {a2} were ignored.', 'options' => ['a1' => ['any', 'some', 'no'], 'a2' => ['many', 'all', 'none']], 'answers' => ['a1' => 'any', 'a2' => 'all'], 'verb_hints' => ['a1' => 'not', 'a2' => null]],
                ...
                'past' => [
                    ...
                    ['question' => 'When the data leaked, {a1} accepted responsibility while {a2} stayed silent.', 'options' => ['a1' => ['someone', 'anyone', 'no one'], 'a2' => ['everyone', 'someone', 'no one']], 'answers' => ['a1' => 'no one', 'a2' => 'everyone'], 'verb_hints' => ['a1' => 'not', 'a2' => null]],
