...
class FutureTensesComprehensiveAiSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($sections as $sectionKey => $sectionQuestions) {
            foreach ($sectionQuestions as $index => $question) {
                $uuid = (string) Uuid::uuid5(Uuid::NAMESPACE_URL, 'future-tenses-comprehensive-' . $sectionKey . '-' . $index . '-' . $question['question']);
