    ...
    public function run(): void
    {
        ...
        $levels = [
            'A1' => [
                ...
                ['pattern' => 'future_simple_question', 'question' => 'What time {a1} your sister tomorrow?', 'forms' => $this->forms('you', 'call', 'calling', 'called')],
                ['pattern' => 'future_simple_question', 'question' => 'Where {a1} us next weekend?', 'forms' => $this->forms('they', 'meet', 'meeting', 'met')],
            ...
            'A2' => [
                ...
                ['pattern' => 'future_simple_question', 'question' => 'Why {a1} the client on Tuesday?', 'forms' => $this->forms('you', 'visit', 'visiting', 'visited')],
                ['pattern' => 'future_simple_question', 'question' => 'Which city {a1} during the holiday?', 'forms' => $this->forms('they', 'explore', 'exploring', 'explored')],
                ...
                ['pattern' => 'future_continuous_question', 'question' => 'Who {a1} after lunch?', 'forms' => $this->forms('you', 'meet', 'meeting', 'met')],
                ['pattern' => 'future_continuous_question', 'question' => 'Where {a1} during the festival?', 'forms' => $this->forms('we', 'stay', 'staying', 'stayed')],
                ...
                ['pattern' => 'future_perfect_question', 'question' => 'Which chapters {a1} before the seminar?', 'forms' => $this->forms('they', 'read', 'reading', 'read')],
            ...
            'B1' => [
                ...
                ['pattern' => 'future_simple_question', 'question' => 'Why {a1} the proposal without feedback?', 'forms' => $this->forms('you', 'submit', 'submitting', 'submitted')],
                ['pattern' => 'future_simple_question', 'question' => 'Which supplier {a1} after the audit?', 'forms' => $this->forms('they', 'choose', 'choosing', 'chosen')],
                ...
                ['pattern' => 'future_continuous_question', 'question' => 'What {a1} at the conference tomorrow?', 'forms' => $this->forms('you', 'present', 'presenting', 'presented')],
            ...
            'B2' => [
                ...
                ['pattern' => 'future_simple_question', 'question' => 'Why {a1} the preliminary findings?', 'forms' => $this->forms('you', 'challenge', 'challenging', 'challenged')],
                ['pattern' => 'future_simple_question', 'question' => 'Which metrics {a1} in the next review?', 'forms' => $this->forms('they', 'track', 'tracking', 'tracked')],
                ...
                ['pattern' => 'future_continuous_question', 'question' => 'Who {a1} for the feature tomorrow?', 'forms' => $this->forms('you', 'interview', 'interviewing', 'interviewed')],
                ...
                ['pattern' => 'future_perfect_continuous_question', 'question' => 'By 2030, how long {a1} the remote team?', 'forms' => $this->forms('you', 'lead', 'leading', 'led')],
            ...
            'C1' => [
                ...
                ['pattern' => 'future_simple_question', 'question' => 'Why {a1} the narrative before the briefing?', 'forms' => $this->forms('you', 'reframe', 'reframing', 'reframed')],
                ['pattern' => 'future_simple_question', 'question' => 'Which hypotheses {a1} during the symposium?', 'forms' => $this->forms('they', 'prioritize', 'prioritizing', 'prioritized')],
                ...
                ['pattern' => 'future_continuous_question', 'question' => 'Who {a1} when the crisis unfolds?', 'forms' => $this->forms('you', 'consult', 'consulting', 'consulted')],
                ...
                ['pattern' => 'future_perfect_continuous_question', 'question' => 'By 2035, how long {a1} emerging researchers?', 'forms' => $this->forms('you', 'mentor', 'mentoring', 'mentored')],
                ['pattern' => 'future_perfect_continuous_question', 'question' => 'By next decade, how long {a1} with quantum algorithms?', 'forms' => $this->forms('they', 'experiment', 'experimenting', 'experimented')],
            ...
            'C2' => [
                ...
                ['pattern' => 'future_simple_question', 'question' => 'Why {a1} the protocol before peer review?', 'forms' => $this->forms('you', 'recalibrate', 'recalibrating', 'recalibrated')],
                ['pattern' => 'future_simple_question', 'question' => 'Which paradigms {a1} in the forthcoming manifesto?', 'forms' => $this->forms('they', 'interrogate', 'interrogating', 'interrogated')],
                ...
                ['pattern' => 'future_continuous_question', 'question' => 'Who {a1} with while the delegation travels?', 'forms' => $this->forms('you', 'liaise', 'liaising', 'liaised')],
                ...
                ['pattern' => 'future_perfect_continuous_question', 'question' => 'By 2038, how long {a1} the transnational consortium?', 'forms' => $this->forms('you', 'curate', 'curating', 'curated')],
                ['pattern' => 'future_perfect_continuous_question', 'question' => 'By the time regulation shifts, how long {a1} the predictive engine?', 'forms' => $this->forms('they', 'refine', 'refining', 'refined')],
