...
class CaludeDegreesOfComparisonSeeder extends QuestionSeeder
{
    ...
    private function questionEntries(): array
    {
        return [
            ...
            [
                'level' => 'A1',
                'question' => 'An elephant is {a1} than a cat.',
                'answers' => ['a1' => 'bigger'],
                'options' => ['a1' => ['bigger', 'big', 'biggest']],
                'verb_hints' => ['a1' => 'big'],
                'question_hints' => ['For short adjectives, add -er to compare two things.'],
            ...
            [
                ...
                'verb_hints' => ['a1' => 'long'],
                'question_hints' => ['Add -er to short adjectives when comparing two items.'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'verb_hints' => ['a1' => 'heavy'],
                'question_hints' => ['In questions, we still use the comparative form (-er) when comparing two things.'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'question_hints' => ['In the structure "as ... as", use the base form of the adjective.'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'verb_hints' => ['a1' => 'fast'],
                'question_hints' => ['Use -er form for short words when comparing actions of two people.'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'verb_hints' => ['a1' => 'slow'],
                'question_hints' => ['Short adjectives form comparatives with -er.'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'verb_hints' => ['a1' => 'small'],
                'question_hints' => ['Use "the + adjective-est" for superlatives with short adjectives.'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'question_hints' => ['With "as ... as", always use the base form.'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'verb_hints' => ['a1' => 'old'],
                'question_hints' => ['Negative sentences keep the comparative form when using "than".'],
                'chatgpt_explanations' => [
            ...
            [
                'level' => 'A1',
                'question' => 'A mouse is {a1} than a dog.',
                'answers' => ['a1' => 'smaller'],
                'options' => ['a1' => ['smaller', 'small', 'smallest']],
                'verb_hints' => ['a1' => 'small'],
                'question_hints' => ['Use the comparative form to compare two animals.'],
                'chatgpt_explanations' => [
                    'smaller' => 'Порівняння двох тварин потребує comparative. Формула: A is + adjective-er + than B. Приклад: A cat is quieter than a parrot.',
                    'small' => 'Базова форма не виражає порівняння між двома суб\'єктами.',
                    'smallest' => 'Superlative для групи з трьох і більше.',
                ],
            ],
            [
                'level' => 'A1',
                'question' => 'Summer days are {a1} than winter days.',
                'answers' => ['a1' => 'longer'],
                'options' => ['a1' => ['longer', 'long', 'longest']],
                'verb_hints' => ['a1' => 'long'],
                'question_hints' => ['Compare two seasons using -er + than.'],
                'chatgpt_explanations' => [
                    'longer' => 'Порівняння двох типів днів використовує comparative. Додаємо -er до короткого прикметника. Приклад: Spring nights are cooler than summer nights.',
                    'long' => 'Базова форма не показує порівняння.',
                    'longest' => 'Superlative потребує the і групу з трьох і більше.',
                ],
            ],
            [
                'level' => 'A1',
                ...
                'verb_hints' => ['a1' => 'easy'],
                'question_hints' => ['Use "the + adjective-est" for the superlative of short adjectives.'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'verb_hints' => ['a1' => 'cold'],
                'question_hints' => ['For past comparisons, use comparative + than.'],
                'chatgpt_explanations' => [
                    'colder' => 'Порівняння минулого з теперішнім використовує comparative. Формула: past subject + was + adjective-er + than + present subject. Приклад: Last week was busier than this week.',
                    'cold' => 'Базова форма не виражає порівняння.',
                    'coldest' => 'Superlative не поєднується з than.',
                ],
            ],
            [
                'level' => 'A2',
                ...
                'verb_hints' => ['a1' => 'loud'],
                'question_hints' => ['Use the base form of the adverb in "as ... as" structures.'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'question_hints' => ['Longer adjectives use "more + adjective + than" for comparisons.'],
                'chatgpt_explanations' => [
            ...
            [
                'level' => 'A2',
                'question' => 'Was the concert {a1} than the festival?',
                'answers' => ['a1' => 'more exciting'],
                'options' => ['a1' => ['more exciting', 'excitinger', 'most exciting']],
                'verb_hints' => ['a1' => 'exciting'],
                'question_hints' => ['In questions, use "more + adjective + than" for longer adjectives.'],
                'chatgpt_explanations' => [
            ...
            [
                'level' => 'A2',
                'question' => 'This soup tastes {a1} than the one we had last week.',
                'answers' => ['a1' => 'better'],
            ...
            [
                ...
                'question_hints' => ['Use the base form in negative "as ... as" structures.'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'question_hints' => ['Adverbs ending in -ly form comparatives with "more".'],
                'chatgpt_explanations' => [
            ...
            [
                'level' => 'A2',
                'question' => 'This hotel is the {a1} in the city.',
            ...
            [
                ...
                'options' => ['a1' => ['longer', 'long', 'longest']],
                'verb_hints' => ['a1' => 'long'],
                'question_hints' => ['Use comparative + than in past tense questions.'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'verb_hints' => ['a1' => 'neat'],
                'question_hints' => ['Short adjectives add -er for comparisons.'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'verb_hints' => ['a1' => 'safe'],
                'question_hints' => ['Negative comparisons still use "-er + than".'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'question_hints' => ['Use "more + adjective + than" for longer adjectives in past contexts.'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'question_hints' => ['Use the base form in "not as ... as" comparisons.'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'question_hints' => ['Future tense questions use "more + adjective + than" for long adjectives.'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'question_hints' => ['Adverbs ending in -ly use "more + adverb + than".'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'question_hints' => ['Use "less" with uncountable nouns and "fewer" with countable nouns.'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'verb_hints' => ['a1' => 'bad'],
                'question_hints' => ['Use "comparative and comparative" to show gradual change.'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'question_hints' => ['Use "fewer" with countable plural nouns.'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'question_hints' => ['Use "more" to compare quantities in questions.'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'options' => ['a1' => ['better', 'gooder', 'best']],
                'verb_hints' => ['a1' => 'good'],
                'question_hints' => ['Irregular adjectives keep their comparative forms in negatives.'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'verb_hints' => ['a1' => 'hard'],
                'question_hints' => ['Future comparisons use comparative + than.'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'options' => ['a1' => ['more', 'most', 'much']],
                'verb_hints' => ['a1' => 'increase'],
                'question_hints' => ['Use "more" before long adjectives for comparative forms.'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'question_hints' => ['Use the base form in "not as ... as" for comparison.'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'options' => ['a1' => ['harder', 'hard', 'hardest']],
                'verb_hints' => ['a1' => 'intense'],
                'question_hints' => ['Use comparative adverbs in conditional structures.'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'options' => ['a1' => ['more', 'most', 'much']],
                'verb_hints' => ['a1' => 'increase'],
                'question_hints' => ['Use "more + adverb + than" for adverbs in comparisons.'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'options' => ['a1' => ['more', 'most', 'much']],
                'verb_hints' => ['a1' => 'increase'],
                'question_hints' => ['Intensifiers like "considerably" can precede comparative forms.'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'question_hints' => ['Use the base form in questions with "as ... as".'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'question_hints' => ['Use "more" with uncountable nouns for quantity comparison.'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'options' => ['a1' => ['less', 'fewer', 'least']],
                'verb_hints' => ['a1' => 'reduced'],
                'question_hints' => ['Use "less + adjective + than" to compare qualities.'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'verb_hints' => ['a1' => 'useful'],
                'question_hints' => ['Use the base form in "as ... as" to express equality.'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'question_hints' => ['Use "far more" as an intensified comparative.'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'question_hints' => ['Use the base form in "not nearly as ... as" for emphasis.'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'verb_hints' => ['a1' => 'reduced'],
                'question_hints' => ['The double comparative: "The more..., the less...".'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'question_hints' => ['Use "the least + adjective" for negative superlatives.'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'options' => ['a1' => ['more', 'most', 'much']],
                'verb_hints' => ['a1' => 'increase'],
                'question_hints' => ['Use "more + adverb + than" for comparisons with adverbs.'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'options' => ['a1' => ['more', 'most', 'much']],
                'verb_hints' => ['a1' => 'increase'],
                'question_hints' => ['Use "no more + adjective + than" to express equality in a negative sense.'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'options' => ['a1' => ['less', 'least', 'fewer']],
                'verb_hints' => ['a1' => 'reduced'],
                'question_hints' => ['Intensifiers can precede "less + adjective + than".'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'options' => ['a1' => ['far more', 'far most', 'far much']],
                'verb_hints' => ['a1' => 'extensive'],
                'question_hints' => ['Use "far more + adjective + than" for strong comparisons.'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'options' => ['a1' => ['less', 'least', 'fewer']],
                'verb_hints' => ['a1' => 'reduced'],
                'question_hints' => ['The double comparative can show inverse relationships.'],
                'chatgpt_explanations' => [
            ...
            [
                ...
                'question_hints' => ['Use the base form in "not as ... as" structures.'],
                'chatgpt_explanations' => [
