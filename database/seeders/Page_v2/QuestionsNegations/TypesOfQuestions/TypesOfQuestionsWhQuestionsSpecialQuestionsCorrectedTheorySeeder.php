...
class TypesOfQuestionsWhQuestionsSpecialQuestionsCorrectedTheorySeeder extends QuestionsNegationsPageSeeder
{
    protected function slug(): string
    {
        return 'wh-questions-special-questions-who-what-where-when-why-how-corrected';
    }
    ...
    {
        return [
            'title' => 'Wh-questions (Special Questions) — Спеціальні питання: who, what, where, when, why, how (Виправлений)',
