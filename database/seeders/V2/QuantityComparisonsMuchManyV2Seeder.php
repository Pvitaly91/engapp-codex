...
class QuantityComparisonsMuchManyV2Seeder extends QuestionSeeder
{
    ...
    public function run(): void
    {
        ...
        $sourceId = Source::firstOrCreate(['name' => 'test-english.com: much-many-lot-little-few'])->id;
        ...
        $items[] = [
            ...
            'source_id' => $sourceId,
            'level' => 'A1',
            'difficulty' => $this->levelDifficulty['A1'],
            'flag' => 0,
            'type' => 0,
            'tag_ids' => $tagIds,
            'answers' => [
            ...
            'variants' => ['If I want to pass the exam, I need to study {a1}.'],
        ];
        ...
        $items[] = [
            ...
            'variants' => ['There aren\'t {a1} things to do in this village.'],
        ];
        ...
        $items[] = [
            ...
            'variants' => ['{a1} sugar do you take in your tea?'],
        ];
        ...
        $items[] = [
            ...
            'variants' => ['There was {a1} tension at the meeting.'],
        ];
        ...
        $items[] = [
            ...
            'variants' => ['Dad, I need {a1} money for school.'],
        ];
        ...
        $items[] = [
            ...
            'variants' => ['There are {a1} things that you can do to improve your writing.'],
        ];
        ...
        $items[] = [
            ...
            'options' => ['none', 'no', 'any'],
            'variants' => ['There is {a1} milk in the fridge. We need to buy some.'],
        ];
        ...
        $items[] = [
            ...
            'options' => ['none', 'no', 'any'],
            'variants' => ['He doesn\'t have {a1} hobbies.'],
        ];
        ...
        $items[] = [
            ...
            'options' => ['None', 'Any', 'No'],
            'variants' => ['"How many computers do you have?" "{a1}."'],
        ];
        ...
        $items[] = [
            ...
            'variants' => ['I can help you; I have {a1} time today.'],
        ];
        $meta[] = ['uuid' => $uuid, 'answers' => ['a1' => 'a lot of'], 'hints' => ['Quantifiers (A1)']];

        // Exercise 2 (10 questions)
        ...
        $items[] = [
            ...
            'variants' => ['"How much water do you drink?" "{a1}."'],
        ];
        $meta[] = ['uuid' => $uuid, 'answers' => ['a1' => 'A lot'], 'hints' => ['Quantifiers (A1)']];
        ...
        $items[] = [
            ...
            'variants' => ['{a1} goals did they score?'],
        ];
        ...
        $items[] = [
            ...
            'variants' => ['Nowadays we don\'t use {a1} cash, because we use our credit cards.'],
        ];
        ...
        $items[] = [
            ...
            'options' => ['a lot of', 'much', 'many'],
            'variants' => ['There\'s {a1} pressure on the players.'],
        ];
        $meta[] = ['uuid' => $uuid, 'answers' => ['a1' => 'a lot of'], 'hints' => ['Quantifiers (A1)']];
        ...
        $items[] = [
            ...
            'variants' => ['They got married {a1} months after they met for the first time.'],
        ];
        $meta[] = ['uuid' => $uuid, 'answers' => ['a1' => 'a few'], 'hints' => ['Quantifiers (A1)']];
        ...
        $items[] = [
            ...
            'variants' => ['"How much milk do you want in your coffee?" "Only {a1}."'],
        ];
        $meta[] = ['uuid' => $uuid, 'answers' => ['a1' => 'a little'], 'hints' => ['Quantifiers (A1)']];
        ...
        $items[] = [
            ...
            'options' => ['any', 'no', 'none'],
            'variants' => ['There were {a1} problems during the festival.'],
        ];
        $meta[] = ['uuid' => $uuid, 'answers' => ['a1' => 'no'], 'hints' => ['Quantifiers (A1)']];
        ...
        $items[] = [
            ...
            'options' => ['none', 'no', 'any'],
            'variants' => ['I don\'t want {a1} gifts.'],
        ];
        $meta[] = ['uuid' => $uuid, 'answers' => ['a1' => 'any'], 'hints' => ['Quantifiers (A1)']];
        ...
        $items[] = [
            ...
            'options' => ['None', 'Any', 'No'],
            'variants' => ['"How many gifts do you want?" "{a1}."'],
        ];
        $meta[] = ['uuid' => $uuid, 'answers' => ['a1' => 'None'], 'hints' => ['Quantifiers (A1)']];
        ...
        $items[] = [
            ...
            'options' => ['much', 'a lot of', 'many'],
            'variants' => ['I eat {a1} vegetables.'],
        ];
        $meta[] = ['uuid' => $uuid, 'answers' => ['a1' => 'a lot of'], 'hints' => ['Quantifiers (A1)']];

        // Exercise 3 (10 questions) - word bank
        ...
        $items[] = [
            ...
            'options' => $bank,
            'variants' => ['He has {a1} paintings. It\'s a really big collection.'],
        ];
        $meta[] = ['uuid' => $uuid, 'answers' => ['a1' => 'a lot of'], 'hints' => ['Quantifiers (A1)']];
        ...
        $items[] = [
            ...
            'options' => $bank,
            'variants' => ['{a1} salt do you put in your food?'],
        ];
        $meta[] = ['uuid' => $uuid, 'answers' => ['a1' => 'How much'], 'hints' => ['Quantifiers (A1)']];
        ...
        $items[] = [
            ...
            'options' => $bank,
            'variants' => ['I normally use {a1} makeup, but not much, only some lipstick.'],
        ];
        $meta[] = ['uuid' => $uuid, 'answers' => ['a1' => 'a little'], 'hints' => ['Quantifiers (A1)']];
        ...
        $items[] = [
            ...
            'options' => $bank,
            'variants' => ['It rained {a1} last week; it rained every day.'],
        ];
        $meta[] = ['uuid' => $uuid, 'answers' => ['a1' => 'a lot'], 'hints' => ['Quantifiers (A1)']];
        ...
        $items[] = [
            ...
            'options' => $bank,
            'variants' => ['They only scored one goal. They didn\'t have {a1} opportunities to score; maybe two or three.'],
        ];
        $meta[] = ['uuid' => $uuid, 'answers' => ['a1' => 'many'], 'hints' => ['Quantifiers (A1)']];
        ...
        $items[] = [
            ...
            'options' => $bank,
            'variants' => ['Please, I just need 5 minutes of your time. I only have {a1} questions.'],
        ];
        $meta[] = ['uuid' => $uuid, 'answers' => ['a1' => 'a few'], 'hints' => ['Quantifiers (A1)']];
        ...
        $items[] = [
            ...
            'options' => $bank,
            'variants' => ['We had {a1} problems. It was 100% perfect.'],
        ];
        $meta[] = ['uuid' => $uuid, 'answers' => ['a1' => 'no'], 'hints' => ['Quantifiers (A1)']];
        ...
        $items[] = [
            ...
            'options' => $bank,
            'variants' => ['We need to be fast; we haven\'t got {a1} time, only 20 minutes.'],
        ];
        $meta[] = ['uuid' => $uuid, 'answers' => ['a1' => 'much'], 'hints' => ['Quantifiers (A1)']];
        ...
        $items[] = [
            ...
            'options' => $bank,
            'variants' => ['I didn\'t see {a1} people in the room. It was completely empty.'],
        ];
        $meta[] = ['uuid' => $uuid, 'answers' => ['a1' => 'any'], 'hints' => ['Quantifiers (A1)']];
