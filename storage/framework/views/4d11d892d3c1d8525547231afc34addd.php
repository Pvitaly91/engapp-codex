...
<div class="mx-auto max-w-3xl px-4 py-8 text-stone-800" id="quiz-app">
    ...
    <?php echo $__env->make('components.saved-test-progress', ['progress' => '1 / 0'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.engram', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/pvital01/data/www/gramlyze.com/resources/views/engram/saved-test-js-step-input.blade.php ENDPATH**/ ?>