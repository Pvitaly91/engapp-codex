...
<section class="grammar-card" lang="uk">
  <header>
    <h2 class="gw-title">Zero Conditional — загальні факти та рутини</h2>
    <p class="gw-sub">Використовуємо, коли результат завжди відбувається за певної умови: закони природи, інструкції, правила.
    </p>
  </header>
  ...
  <div class="gw-grid">
    <div class="gw-col">
      ...
      <div class="gw-box">
        <h3>Формули та варіації</h3>
        <div class="gw-code-badge">Основна</div>
        <pre class="gw-formula">If + Present Simple, Present Simple
If plants <span style="color:#86efac">don&rsquo;t get</span> water, they <span style="color:#86efac">die</span>.</pre>
...
If he <span style="color:#86efac">has finished</span>, he <span style="color:#86efac">goes</span> home.</pre>
    ...
    <div class="gw-col">
      ...
      <div class="gw-box gw-box--scroll">
        <h3>Zero vs First Conditional</h3>
...
<?php /**PATH G:\DEV\htdocs\engapp-codex.loc\resources\views/engram/pages/static/conditionals/zero.blade.php ENDPATH**/ ?>