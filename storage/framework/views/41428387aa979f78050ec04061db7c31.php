...
<section class="grammar-card" lang="uk">
  <header>
    <h2 class="gw-title">Third Conditional — нереальне минуле</h2>
    <p class="gw-sub">Описуємо ситуації, які <strong>не відбулися</strong> в минулому, та їх можливі наслідки. Використовуємо для
      жалю, аналізу помилок та уявних альтернатив.</p>
  </header>
  ...
  <div class="gw-grid">
    <div class="gw-col">
      <div class="gw-box">
        <h3>Коли вживати?</h3>
        <ul class="gw-list">
          <li><strong>Жаль</strong> про минуле: If I had left earlier, I wouldn&rsquo;t have missed the flight.</li>
          <li><strong>Альтернативні сценарії</strong>: If they had studied, they would have passed.</li>
          <li><strong>Критика</strong>: If he had listened, we wouldn&rsquo;t have been late.</li>
        </ul>
...
<?php /**PATH /var/www/pvital01/data/www/gramlyze.com/resources/views/engram/pages/static/conditionals/third.blade.php ENDPATH**/ ?>