...
<body class="bg-gray-50 min-h-screen flex flex-col">
    ...
    <nav class="bg-white shadow mb-6" x-data="{ open: false }">
        <div class="container mx-auto px-4">
            <div class="flex items-center justify-between py-4">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="text-2xl font-bold text-blue-700">
                    Admin Hub
                </a>
                <button
                    type="button"
                ...
                <div class="hidden md:flex md:items-center md:gap-6 text-gray-600 font-medium">
                    <a href="<?php echo e(route('pages.manage.index')); ?>" class="hover:text-blue-500 transition">Сторінки</a>
                    <a href="<?php echo e(route('grammar-test')); ?>" class="hover:text-blue-500 transition">Граматика</a>
                    <a href="<?php echo e(route('saved-tests.list')); ?>" class="hover:text-blue-500 transition">Збережені тести</a>
                    ...
                    >
                        ...
                        >
                            <?php if($supportsShell): ?>
                                <a href="<?php echo e(route('deployment.index')); ?>" class="block px-4 py-2 hover:bg-blue-50">Shell версія</a>
                            <?php endif; ?>
                            <a href="<?php echo e(route('deployment.native.index')); ?>" class="block px-4 py-2 hover:bg-blue-50">Git</a>
                            <a href="<?php echo e(route('migrations.index')); ?>" class="block px-4 py-2 hover:bg-blue-50">Міграції</a>
                        </div>
                    </div>
                    <a href="<?php echo e(route('home')); ?>" class="hover:text-blue-500 transition">До публічної частини</a>
            ...
            <div
                ...
                x-transition
            >
                <a href="<?php echo e(route('pages.manage.index')); ?>" class="block px-2 py-2 rounded-lg hover:bg-blue-50">Сторінки</a>
                <a href="<?php echo e(route('grammar-test')); ?>" class="block px-2 py-2 rounded-lg hover:bg-blue-50">Граматика</a>
                <a href="<?php echo e(route('saved-tests.list')); ?>" class="block px-2 py-2 rounded-lg hover:bg-blue-50">Збережені тести</a>
                ...
                <div x-data="{ openDeployment: false }" class="space-y-1">
                    ...
                    <div x-show="openDeployment" x-transition x-cloak class="ml-4 space-y-1 text-sm">
                        <?php if($supportsShell): ?>
                            <a href="<?php echo e(route('deployment.index')); ?>" class="block rounded-lg px-2 py-1.5 hover:bg-blue-50">Shell версія</a>
                        <?php endif; ?>
                        <a href="<?php echo e(route('deployment.native.index')); ?>" class="block rounded-lg px-2 py-1.5 hover:bg-blue-50">Git</a>
                        <a href="<?php echo e(route('migrations.index')); ?>" class="block rounded-lg px-2 py-1.5 hover:bg-blue-50">Міграції</a>
                    </div>
                </div>
                <a href="<?php echo e(route('home')); ?>" class="block px-2 py-2 rounded-lg hover:bg-blue-50">До публічної частини</a>
                <?php if(session('admin_authenticated')): ?>
    ...
    <main class="flex-1 container mx-auto px-4">
        ...
        <?php elseif(!request()->is('admin') && !empty($pageTitle)): ?>
...
<?php /**PATH G:\DEV\htdocs\engapp-codex.loc\resources\views/layouts/app.blade.php ENDPATH**/ ?>