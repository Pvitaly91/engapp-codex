...
<section class="grammar-card" lang="uk">
  <style>
    .grammar-card { padding: 16px; max-width: 1100px; }
    .gw-title { font-size: 24px; }
    .gw-sub { font-size: 15px; }
    .gw-box h3 { font-size: 17px; }
    .gw-formula { font-size: 13px; }
    .gw-ex { font-size: 14px; }
    .gw-table { display: block; overflow-x: auto; }
    .gw-table th,
    .gw-table td { padding: 8px; }
    .gw-hint { font-size: 14px; }
...
<?php /**PATH /var/www/pvital01/data/www/gramlyze.com/resources/views/engram/pages/static/theory.blade.php ENDPATH**/ ?>