    ...
    <div class="mx-auto max-w-6xl space-y-8">
        ...
        <section class="rounded-2xl border border-gray-200 bg-white p-6 shadow">
            <header class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                ...
                <a href="<?php echo e(route('pages.manage.blocks.create', $page)); ?>" class="inline-flex items-center rounded-xl bg-blue-600 px-4 py-2 text-sm font-semibold text-white shadow hover:bg-blue-700">+ Новий блок</a>
            </header>
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex justify-end gap-2">
                                            <a href="<?php echo e(route('pages.manage.blocks.edit', [$page, $block])); ?>" class="rounded-lg border border-gray-300 px-3 py-1 text-sm text-gray-700 hover:bg-gray-100">Редагувати</a>
                                            <form action="<?php echo e(route('pages.manage.blocks.destroy', [$page, $block])); ?>" method="POST" onsubmit="return confirm('Видалити цей блок?');">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\DEV\htdocs\engapp-codex.loc\resources\views/engram/pages/manage/edit.blade.php ENDPATH**/ ?>