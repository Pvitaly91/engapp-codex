<div class="mx-auto max-w-4xl space-y-6">
    <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        <a href="<?php echo e(route('pages.manage.index')); ?>" class="inline-flex items-center rounded-xl border border-gray-300 px-4 py-2 text-sm font-medium text-gray-600 hover:text-gray-900">← До списку</a>
    </div>
    ...
    <form method="POST" action="<?php echo e($formAction); ?>" class="space-y-6">
                ...
                <label class="space-y-2 md:col-span-2">
                    ...
                    <select name="page_category_id" required class="w-full rounded-xl border border-gray-300 bg-white px-3 py-2 focus:border-blue-500 focus:ring focus:ring-blue-200">
                        ...
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($category->id); ?>" <?php if(old('page_category_id', $page->page_category_id) == $category->id): echo 'selected'; endif; ?>>
                                <?php echo e($category->title); ?> — <?php echo e(strtoupper($category->language)); ?>
        ...
        <div class="flex items-center justify-end gap-3">
            <a href="<?php echo e(route('pages.manage.index')); ?>" class="rounded-xl border border-gray-300 px-4 py-2 text-sm font-medium text-gray-600 hover:text-gray-900">Скасувати</a>
...
<?php /**PATH G:\DEV\htdocs\engapp-codex.loc\resources\views/engram/pages/manage/partials/form.blade.php ENDPATH**/ ?>