...
<head>
  ...
  <title><?php echo $__env->yieldContent('title', 'Engram — Вивчення англійської'); ?></title>
    ...
    <div class="container mx-auto px-4">
      <div class="flex flex-wrap items-center justify-between gap-4 py-4 md:h-16 md:flex-nowrap">
        ...
        <nav class="order-3 w-full flex flex-wrap items-center gap-4 text-sm md:order-none md:w-auto md:flex-nowrap md:gap-6">
          <a class="text-muted-foreground hover:text-foreground" href="<?php echo e(route('catalog-tests.cards')); ?>">Тести</a>
          <a class="text-muted-foreground hover:text-foreground" href="<?php echo e(route('pages.index')); ?>">Теорія</a>
        </nav>
        <div class="flex items-center gap-2 order-2 ml-auto md:order-none md:ml-0">
          <form action="<?php echo e(route('site.search')); ?>" method="GET" class="hidden md:block relative">
      ...
      <div id="mobile-search" class="md:hidden hidden pb-3">
        <form action="<?php echo e(route('site.search')); ?>" method="GET" class="relative">
...
<?php /**PATH /var/www/pvital01/data/www/gramlyze.com/resources/views/layouts/engram.blade.php ENDPATH**/ ?>