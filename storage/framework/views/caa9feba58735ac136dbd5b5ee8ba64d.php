...
<div class="mx-auto max-w-4xl space-y-6">
    <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        <a href="<?php echo e(route('pages-v2.manage.edit', $page)); ?>" class="inline-flex items-center rounded-xl border border-gray-300 px-4 py-2 text-sm font-medium text-gray-600 hover:text-gray-900">← До блоків сторінки</a>
    </div>
    ...
    <form method="POST" action="<?php echo e($formAction); ?>" class="space-y-6">
        ...
        <div class="flex items-center justify-end gap-3">
            <a href="<?php echo e(route('pages-v2.manage.edit', $page)); ?>" class="rounded-xl border border-gray-300 px-4 py-2 text-sm font-medium text-gray-600 hover:text-gray-900">Скасувати</a>
...
<?php /**PATH G:\DEV\htdocs\engapp-codex.loc\resources\views/engram/pages/v2/manage/blocks/partials/form.blade.php ENDPATH**/ ?>