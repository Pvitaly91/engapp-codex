    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div>
            <h1 class="text-2xl font-bold text-stone-900"><?php echo e($test->name); ?> 
                ...
                <a href="<?php echo e(route('saved-test.js', $test->slug)); ?>"
                class="px-3 py-1.5 rounded-2xl border border-stone-200 bg-white shadow-sm text-sm font-semibold text-stone-700 hover:bg-stone-50">
                    JS режим
                </a>
            </h1>
...
<script>
    (() => {
        ...
        const routes = {
            ...
            question: '<?php echo e(url('/questions')); ?>',
            answer: '<?php echo e(url('/question-answers')); ?>',
            variant: '<?php echo e(url('/question-variants')); ?>',
            option: '<?php echo e(url('/questions')); ?>',
            questionHint: '<?php echo e(url('/question-hints')); ?>',
            verbHint: '<?php echo e(url('/verb-hints')); ?>',
            chatgptExplanation: '<?php echo e(url('/chatgpt-explanations')); ?>',
            deleteQuestion: '<?php echo e(url('/test/' . $test->slug . '/question')); ?>',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/pvital01/data/www/gramlyze.com/resources/views/engram/saved-test-tech.blade.php ENDPATH**/ ?>