        ...
        <?php if($tableExists): ?>
            <div >
                <div class="bg-white shadow rounded-lg p-6 my-4">
                    ...
                    <?php else: ?>
                        <ul class="space-y-3">
                            <?php $__currentLoopData = $pendingSeeders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pendingSeeder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="flex items-center justify-between gap-4">
                                    <span class="text-sm font-mono text-gray-700 break-all"><?php echo e($pendingSeeder->display_class_name); ?></span>
                                    <div class="flex items-center gap-2">
                                        <?php if($pendingSeeder->is_question_seeder): ?>
                                            <a href="<?php echo e(route('seed-runs.preview', ['class_name' => $pendingSeeder->class_name])); ?>" class="inline-flex items-center gap-2 px-3 py-1.5 bg-sky-100 text-sky-700 text-xs font-medium rounded-md hover:bg-sky-200 transition">
                                        ...
                                        <form method="POST" action="<?php echo e(route('seed-runs.run')); ?>" data-preloader>
                                            <?php echo csrf_field(); ?>
                                            <input type="hidden" name="class_name" value="<?php echo e($pendingSeeder->class_name); ?>">
                ...
                <div class="bg-white shadow rounded-lg p-6 overflow-hidden">
                    ...
                    <?php if($executedSeederHierarchy->isEmpty()): ?>
                        <p class="text-sm text-gray-500">Поки що немає виконаних сидерів.</p>
                    <?php else: ?>
                        <div class="space-y-4">
                            <?php $__currentLoopData = $executedSeederHierarchy; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $node): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\DEV\htdocs\engapp-codex.loc\resources\views/seed-runs/index.blade.php ENDPATH**/ ?>