...
<div class="max-w-7xl mx-auto p-4 space-y-6">
    ...
    <form action="<?php echo e($generateRoute); ?>" method="POST" class="bg-white shadow rounded-2xl p-4 sm:p-6">
        <?php echo csrf_field(); ?>
            ...
            <div class="space-y-6 ">
                <div x-data="{ openSeederFilter: <?php echo e(($hasSelectedSeederClasses || $hasSelectedSeederSources) ? 'true' : 'false'); ?>, toggleSeederSources(open) { this.$dispatch('toggle-all-seeder-sources', { open }); } }"
                    ...
                    <div class="space-y-3" x-show="openSeederFilter" x-transition style="display: none;">
                        ...
                        <?php else: ?>
                            <div class="grid gap-3 sm:grid-cols-2 xl:grid-cols-3 items-start">
                                <?php $__currentLoopData = $seederGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <span class="flex min-w-0 flex-col text-left" title="<?php echo e($displaySeederName); ?>">
                ...
                <?php if($sourceGroups->isNotEmpty()): ?>
                    <div x-data="{ openSources: <?php echo e(($hasSelectedSources || $hasSelectedCategories || $errors->has('categories')) ? 'true' : 'false'); ?> }"
                         class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                            'space-y-3 border border-transparent rounded-2xl p-3',
                        ...
                        <div x-show="openSources" x-transition style="display: none;">
                            <div class="grid gap-3 sm:grid-cols-2 xl:grid-cols-3 items-start">
                                <?php $__currentLoopData = $sourceGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    ?>
                                    <div x-data="{ open: <?php echo e($groupIsActive ? 'true' : 'false'); ?> }"
                                         class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                            'border rounded-2xl overflow-hidden transition',
                                            'border-gray-200' => ! $groupIsActive,
                                            'border-blue-400 shadow-sm bg-blue-50' => $groupIsActive,
                                    ...
                                    >
                                        <div class="flex items-start justify-between gap-3 px-4 py-2 bg-gray-50">
                                            <label for="<?php echo e($categoryInputId); ?>"
                                                   class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                                        'flex flex-1 min-w-0 items-start gap-2 text-sm font-semibold text-gray-800 cursor-pointer',
                                                        'text-blue-800' => $categoryIsSelected,
                                                   ]); ?>">
                                                <input type="checkbox" name="categories[]" value="<?php echo e($categoryId); ?>" id="<?php echo e($categoryInputId); ?>"
                                                       <?php echo e($categoryIsSelected ? 'checked' : ''); ?>

                                                       class="h-4 w-4 text-blue-600 border-gray-300 rounded flex-shrink-0">
                                                <span class="flex min-w-0 items-start gap-2" title="<?php echo e(ucfirst($category->name)); ?> (ID: <?php echo e($categoryId); ?>)">
                                                    <span class="truncate"><?php echo e(ucfirst($category->name)); ?> (ID: <?php echo e($categoryId); ?>)</span>
                                                    <?php if($categoryIsNew): ?>
                                                        <span class="text-[10px] uppercase font-bold text-amber-700 bg-amber-100 px-2 py-0.5 rounded-full">
                                                            Новий<?php echo e(!is_null($categoryOrdinal) ? ' #' . $categoryOrdinal : ''); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                                <div class="text-red-500 text-sm mt-3"><?php echo e($message); ?></div>
                            <?php unset($message);
                                    ...
                                    <div x-show="open" x-transition style="display: none;" class="px-4 pb-4 pt-2">
                                        <div class="flex flex-wrap gap-2">
                                            <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <?php $tagIsNew = $recentTagIds->contains($tag->id); ?>
                                                <?php $tagOrdinal = $recentTagOrdinals->get($tag->id); ?>
                                                <div>
                                                    ...
                                                    <label for="<?php echo e($tagId); ?>" class="px-3 py-1 rounded-full border border-gray-200 cursor-pointer text-sm bg-gray-100 peer-checked:bg-blue-600 peer-checked:text-white flex items-center gap-2">
                                                        <span><?php echo e($tag->name); ?></span>
                                                        <?php if($tagIsNew): ?>
                                                            <span class="text-[10px] uppercase font-bold text-amber-700 bg-amber-100 px-2 py-0.5 rounded-full">
                                                                Новий<?php echo e(!is_null($tagOrdinal) ? ' #' . $tagOrdinal : ''); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\DEV\htdocs\engapp-codex.loc\resources\views/grammar-test.blade.php ENDPATH**/ ?>