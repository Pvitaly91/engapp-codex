...
<?php $__env->startSection('title', $test->name . ' — Технічна сторінка'); ?>
...
<div class="max-w-6xl mx-auto px-4 py-6 space-y-6">
    <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div>
            <h1 class="text-2xl font-bold text-stone-900"><?php echo e($test->name); ?>
                ...
                <a href="<?php echo e($primaryJsRoute); ?>"
                class="px-3 py-1.5 rounded-2xl border border-stone-200 bg-white shadow-sm text-sm font-semibold text-stone-700 hover:bg-stone-50">
                    JS режим
                </a>
            </h1>
            ...
            <p class="text-sm text-stone-600 mt-1">
                ...
                <span class="font-semibold text-stone-700" data-questions-count><?php echo e($questions->count()); ?></span>
            </p>
    ...
    <div class="space-y-5" data-questions-container>
        ...
        <article class="bg-white shadow rounded-2xl p-6 space-y-5 border border-stone-100"
                 ...
                 data-question='<?php echo json_encode($techQuestionData, 15, 512) ?>'>
            <header class="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                    <div>
                        <div class="flex items-baseline gap-3 text-sm text-stone-500">
                            <span class="font-semibold uppercase tracking-wide">Питання <span data-question-number><?php echo e($loop->iteration); ?></span></span>
                            <span>ID: <?php echo e($question->id); ?></span>
                            <span class="flex items-center gap-1 font-mono text-[11px] uppercase tracking-wide text-stone-400 break-all">
                                <span>UUID:</span>
                                <span data-question-uuid><?php echo e($question->uuid ?? '—'); ?></span>
                            </span>
                        </div>
                        <p class="mt-2 text-lg leading-relaxed text-stone-900" data-question-text><?php echo $filledQuestion; ?></p>
                    <div class="mt-2 flex flex-wrap gap-2 text-xs font-semibold">
                        <button type="button"
                                class="inline-flex items-center gap-1 rounded-full bg-blue-50 px-3 py-1 text-blue-700 hover:bg-blue-100"
                                onclick="techEditor.editQuestion(<?php echo e($question->id); ?>)">
                        ...
                        <button type="button"
                                ...
                                onclick="techEditor.exportQuestion(<?php echo e($question->id); ?>)">
                            <svg class="h-3.5 w-3.5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                        ...
                        <button type="button"
                                ...
                                onclick="techEditor.deleteQuestion(<?php echo e($question->id); ?>)">
                            <svg class="h-3.5 w-3.5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <span class="inline-flex items-center px-3 py-1 rounded-full bg-stone-900 text-white text-sm font-semibold" data-question-level><?php echo e($levelLabel); ?></span>
                    <button type="button"
                            class="text-xs font-semibold text-blue-600 underline hover:text-blue-800"
                            onclick="techEditor.editQuestionLevel(<?php echo e($question->id); ?>)">
                        Змінити
                    </button>
                </div>
            </header>
                            ...
                            <?php $__currentLoopData = $variants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $variant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="flex flex-col gap-1 rounded-lg border border-stone-200 bg-stone-50 px-3 py-2"
                                    ...
                                    <div class="flex items-center justify-between gap-2">
                                        <span class="font-mono text-[11px] uppercase text-stone-500">Варіант <?php echo e($loop->iteration); ?></span>
                                        <div class="flex items-center gap-2">
                                            <button type="button" class="text-[11px] font-semibold text-blue-600 underline hover:text-blue-800"
                                                    onclick="techEditor.editVariant(<?php echo e($question->id); ?>, <?php echo e($variant->id); ?>)">Редагувати</button>
                                            <button type="button" class="text-[11px] font-semibold text-red-600 underline hover:text-red-700"
                                                    onclick="techEditor.deleteVariant(<?php echo e($question->id); ?>, <?php echo e($variant->id); ?>)">Видалити</button>
                                        </div>
                                    </div>
                                    <span data-variant-text><?php echo $highlightSegments($variant->text); ?></span>
                                </li>
            ...
            <details class="group">
                ...
                <div class="mt-3 flex flex-wrap gap-2">
                    <button type="button"
                            ...
                            onclick="techEditor.addAnswer(<?php echo e($question->id); ?>)">
                    ...
                    <button type="button"
                            ...
                            onclick="techEditor.addVerbHint(<?php echo e($question->id); ?>)">
                        <span>Додати verb hint</span>
                    </button>
                </div>
                <ul class="mt-3 space-y-2 text-sm text-stone-800" data-answers-container>
                    <?php $__empty_2 = true; $__currentLoopData = $question->answers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $answer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                        <?php
                            $marker = strtoupper($answer->marker);
                            $markerKey = strtolower($answer->marker);
                        ...
                        <li class="flex flex-wrap items-center justify-between gap-3 rounded-lg border border-emerald-100 bg-emerald-50/70 px-3 py-2"
                            ...
                            <div class="flex flex-wrap items-center gap-2 text-sm">
                                <span class="font-mono text-xs uppercase text-emerald-500"><?php echo e($marker); ?></span>
                                <span class="font-semibold text-emerald-900" data-answer-value><?php echo e($answerValue); ?></span>
                                <?php if($verbHintValue): ?>
                                    <span class="inline-flex items-center gap-1 rounded-full bg-white px-2 py-0.5 text-[11px] font-medium text-emerald-700"
                                        data-verb-hint <?php if($verbHintModel): ?> data-verb-hint-id="<?php echo e($verbHintModel->id); ?>" <?php endif; ?>>
                                        <span class="font-semibold uppercase text-[10px] tracking-wide">Verb hint</span>
                                        <span data-verb-hint-value><?php echo e($verbHintValue); ?></span>
                                        <?php if($verbHintModel): ?>
                                            <button type="button" class="text-[10px] font-semibold text-blue-600 underline hover:text-blue-800"
                                                    onclick="techEditor.editVerbHint(<?php echo e($question->id); ?>, <?php echo e($verbHintModel->id); ?>)">Редагувати</button>
                                            <button type="button" class="text-[10px] font-semibold text-red-600 underline hover:text-red-700"
                                                    onclick="techEditor.deleteVerbHint(<?php echo e($question->id); ?>, <?php echo e($verbHintModel->id); ?>)">Видалити</button>
                                        <?php endif; ?>
                                    </span>
                                <?php else: ?>
                                    <button type="button"
                                            class="text-[11px] font-semibold text-blue-600 underline hover:text-blue-800"
                                            onclick="techEditor.addVerbHint(<?php echo e($question->id); ?>, '<?php echo e($markerKey); ?>')">
                                        Додати verb hint
                                    </button>
                                <?php endif; ?>
                            </div>
                            <div class="flex items-center gap-2">
                                <button type="button" class="text-xs font-semibold text-blue-600 underline hover:text-blue-800"
                                        onclick="techEditor.editAnswer(<?php echo e($question->id); ?>, <?php echo e($answer->id); ?>)">Редагувати відповідь</button>
                                <button type="button" class="text-xs font-semibold text-red-600 underline hover:text-red-700"
                                        onclick="techEditor.deleteAnswer(<?php echo e($question->id); ?>, <?php echo e($answer->id); ?>)">Видалити</button>
                            </div>
                        </li>
            ...
            <details class="group">
                ...
                <div class="mt-3 flex flex-wrap gap-2">
                    <button type="button"
                            class="inline-flex items-center gap-1 rounded-full border border-blue-200 bg-blue-50 px-3 py-1 text-xs font-semibold text-blue-700 shadow-sm transition hover:bg-blue-100"
                            onclick="techEditor.addOption(<?php echo e($question->id); ?>)">
                        <span>Додати варіант</span>
                    </button>
                </div>
                <div class="mt-3 flex flex-wrap gap-2" data-options-container>
                    <?php $__empty_2 = true; $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                        <?php $isCorrectOption = (bool) ($option['is_correct'] ?? false); ?>
                        ...
                        data-option-id="<?php echo e($option['id'] ?? ''); ?>">
                            ...
                            <?php if(! empty($option['id'])): ?>
                                <button type="button" class="text-xs font-semibold text-blue-600 underline hover:text-blue-800"
                                        onclick="techEditor.editOption(<?php echo e($question->id); ?>, <?php echo e($option['id']); ?>)">Редагувати</button>
                                <button type="button" class="text-xs font-semibold text-red-600 underline hover:text-red-700"
                                        onclick="techEditor.deleteOption(<?php echo e($question->id); ?>, <?php echo e($option['id']); ?>)">Видалити</button>
                            <?php endif; ?>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_2): ?>
            ...
            <details class="group">
                ...
                <div class="mt-3 flex flex-wrap gap-2">
                    <button type="button"
                            class="inline-flex items-center gap-1 rounded-full border border-blue-200 bg-blue-50 px-3 py-1 text-xs font-semibold text-blue-700 shadow-sm transition hover:bg-blue-100"
                            onclick="techEditor.addQuestionHint(<?php echo e($question->id); ?>)">
                        <span>Додати підказку</span>
                    </button>
                </div>
                <ul class="mt-3 space-y-3 text-sm text-stone-800" data-question-hints-container>
                    <?php $__empty_2 = true; $__currentLoopData = $questionHints; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hint): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                        <li class="rounded-lg border border-blue-100 bg-blue-50/60 px-3 py-2"
                            data-question-hint-id="<?php echo e($hint->id); ?>">
                            <div class="flex items-center justify-between gap-2 text-xs font-semibold uppercase tracking-wide text-blue-700">
                                <span><?php echo e($hint->provider); ?> · <?php echo e(strtoupper($hint->locale)); ?></span>
                                <div class="flex items-center gap-2">
                                    <button type="button" class="text-[11px] font-semibold text-blue-600 underline hover:text-blue-800"
                                            onclick="techEditor.editQuestionHint(<?php echo e($question->id); ?>, <?php echo e($hint->id); ?>)">Редагувати</button>
                                    <button type="button" class="text-[11px] font-semibold text-red-600 underline hover:text-red-700"
                                            onclick="techEditor.deleteQuestionHint(<?php echo e($question->id); ?>, <?php echo e($hint->id); ?>)">Видалити</button>
                                </div>
                            </div>
                            <div class="mt-1 whitespace-pre-line text-stone-800" data-question-hint-text><?php echo e($hint->hint); ?></div>
                        </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_2): ?>
                ...
                <summary class="flex cursor-pointer select-none items-center justify-between gap-2 text-xs font-semibold uppercase tracking-wide text-stone-500">
                    ...
                    <div class="mt-3 flex flex-col gap-2">
                        <div class="flex flex-wrap gap-2">
                            <button type="button"
                                class="inline-flex items-center gap-1 rounded-full border border-blue-200 bg-blue-50 px-3 py-1 text-xs font-semibold text-blue-700 shadow-sm transition hover:bg-blue-100 <?php if (! ($canAddChatGptExplanation)): ?> opacity-60 cursor-not-allowed <?php endif; ?>"
                                data-add-chatgpt-explanation
                                data-question-id="<?php echo e($question->id); ?>"
                                <?php if (! ($canAddChatGptExplanation)): ?> disabled <?php endif; ?>
                                onclick="techEditor.addChatGptExplanation(<?php echo e($question->id); ?>)">
                                <span>Додати пояснення</span>
                            </button>
                        </div>
                        <p class="text-xs text-stone-500 <?php if($canAddChatGptExplanation): ?> hidden <?php endif; ?>" data-chatgpt-explanation-hint>
                ...
                <div class="mt-3 overflow-x-auto">
                    <table class="min-w-full text-left text-sm text-stone-800">
                        ...
                        <tbody class="align-top" data-explanations-container>
                            <?php $__empty_2 = true; $__currentLoopData = $explanations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $explanation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                <?php
                                    $isStoredCorrect = $answersByMarker->contains(function ($value) use ($explanation) {
                                        return $value === $explanation->correct_answer;
                                    });
                                ?>
                                <tr class="border-t border-stone-200" data-explanation-id="<?php echo e($explanation->id); ?>">
                                    <td class="py-2 pr-4 font-semibold text-stone-600"><?php echo e(strtoupper($explanation->language)); ?></td>
                                    <td class="py-2 pr-4"><?php echo e($explanation->wrong_answer ?: '—'); ?></td>
                                    <td class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                        ...
                                        <?php echo e($explanation->correct_answer); ?>

                                    </td>
                                    <td class="py-2"><?php echo e($explanation->explanation); ?></td>
                                    <td class="py-2 text-right">
                                        <button type="button" class="text-xs font-semibold text-red-600 underline hover:text-red-700"
                                                onclick="techEditor.deleteChatGptExplanation(<?php echo e($question->id); ?>, <?php echo e($explanation->id); ?>)">Видалити</button>
                                    </td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_2): ?>
                                <tr>
...
<script>
    (() => {
        const techCsrfToken = '<?php echo e(csrf_token()); ?>';
        const routes = {
            createQuestion: '<?php echo e(route('saved-test.questions.store', $test->slug)); ?>',
            question: '<?php echo e(url('/admin/questions')); ?>',
            answer: '<?php echo e(url('/admin/question-answers')); ?>',
            variant: '<?php echo e(url('/admin/question-variants')); ?>',
            option: '<?php echo e(url('/admin/questions')); ?>',
            questionHint: '<?php echo e(url('/admin/question-hints')); ?>',
            verbHint: '<?php echo e(url('/admin/verb-hints')); ?>',
            chatgptExplanation: '<?php echo e(url('/admin/chatgpt-explanations')); ?>',
            deleteQuestion: '<?php echo e(url('/admin/test/' . $test->slug . '/question')); ?>',
            exportQuestionByUuid: '<?php echo e(route('questions.export-by-uuid')); ?>',
            deleteAllQuestions: '<?php echo e(route('saved-test.questions.destroy-all', $test->slug)); ?>',
            restoreQuestionsFromDumps: '<?php echo e(route('questions.restore-from-dumps')); ?>',
            restoreQuestionByUuid: '<?php echo e(route('questions.restore-by-uuid')); ?>',
        };

        const cefrLevels = <?php echo json_encode($cefrLevels, 15, 512) ?>;
        const initialHintProviders = <?php echo json_encode($availableHintProviders->all(), 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\DEV\htdocs\engapp-codex.loc\resources\views/engram/saved-test-tech.blade.php ENDPATH**/ ?>