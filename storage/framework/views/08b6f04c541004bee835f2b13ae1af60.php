...
<div class="flex flex-col md:flex-row gap-6">
    ...
    <aside id="filters" class="md:w-48 w-full md:shrink-0 hidden md:block md:sticky md:top-20 md:self-start bg-card md:bg-transparent md:p-0 p-4 rounded-2xl shadow-soft md:shadow-none">
        ...
        <form id="tag-filter" action="<?php echo e(route('catalog-tests.cards')); ?>" method="GET">
        ...
        <?php if(!empty($selectedTags) || !empty($selectedLevels)): ?>
            <div class="mt-2">
                <a href="<?php echo e(route('catalog-tests.cards')); ?>" class="text-xs text-muted-foreground hover:underline">Скинути фільтр</a>
            </div>
        <?php endif; ?>
    </aside>
    <div class="flex-1">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <?php $__currentLoopData = $tests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $test): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-card text-card-foreground p-4 rounded-2xl shadow-soft flex flex-col">
                        ...
                        <?php endif; ?>
                        <a href="<?php echo e(route('saved-test.js', $test->slug)); ?>" class="mt-auto inline-block text-center bg-primary hover:bg-primary/80 text-primary-foreground px-4 py-2 rounded-2xl text-sm font-semibold">Пройти тест</a>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        <?php else: ?>
...
<?php echo $__env->make('layouts.engram', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/pvital01/data/www/gramlyze.com/resources/views/engram/catalog-tests-cards.blade.php ENDPATH**/ ?>