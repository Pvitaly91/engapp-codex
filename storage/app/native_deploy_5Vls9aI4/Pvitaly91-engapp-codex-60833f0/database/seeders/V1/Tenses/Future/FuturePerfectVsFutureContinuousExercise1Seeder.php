...
class FuturePerfectVsFutureContinuousExercise1Seeder extends Seeder
{
    public function run()
    {
        ...
        $questions = [
            ...
            [
                'question' => 'Nina is going on vacation. She {a2} on the beach at this time next week.',
            ...
            [
                'question' => 'I usually have my lunch at work. At 1 pm today, I {a3} my lunch too and won’t be able to talk to you.',
            ...
            [
                'question' => 'John started the project last week. By next Friday, he {a4} it.',
            ...
            [
                'question' => 'Pete has been driving the whole day. By 10 pm tonight, he {a5} his destination.',
            ...
            [
                'question' => 'The film starts at 7 pm. At this time tonight, I {a6} it.',
