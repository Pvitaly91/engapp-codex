...
class SavedTestStepUniqueCountTest extends TestCase
{
    /** @test */
    public function total_counts_each_question_once(): void
    {
        $migrations = [
        ...
        $this->get('/admin/test/'.$testModel->slug.'/step?nav=prev');
        ...
        $response->assertSee('Total: <b>1 / 2</b>', false);
    }
}
