...
class PageController extends Controller
{
    ...
    public function __construct(
        ...
        private TextBlockToQuestionsMatcherService $textBlockQuestionMatcherService
    ) {}
        ...
        if ($this->pageType === 'theory') {
            foreach ($blocks as $block) {
                ...
                $questions = $this->textBlockQuestionMatcherService
                    ->findBestQuestionsForTextBlock($block, $limit, $usedQuestionIds);

                if ($questions->count() < $limit) {
                    $questions = $this->textBlockQuestionMatcherService
                        ->findBestQuestionsForTextBlock($block, $limit, []);
                }
