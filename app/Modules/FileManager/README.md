...
- Підсвітка синтаксису для популярних мов (PHP, Blade/HTML, CSS, JS тощо) з автоматичним завантаженням підсвітки навіть при відкритті сторінки за прямим посиланням
