...
## Модуль "FileManager"
Цей модуль додає в адмін-панель файловий менеджер для перегляду структури папок і файлів проекту відносно document root. Модуль підтримує попередній перегляд текстових файлів, відображає статистику та забезпечує безпеку через налаштування прихованих шляхів. Детальна інструкція з встановлення знаходиться у файлі `app/Modules/FileManager/README.md`.
