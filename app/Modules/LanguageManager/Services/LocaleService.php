...
class LocaleService
{
    ...
    {
        if (self::$cachedHasLanguagesTable !== null) {
            return self::$cachedHasLanguagesTable;
        }

        try {
            return self::$cachedHasLanguagesTable = Schema::hasTable('languages');
        } catch (\Throwable $e) {
            return self::$cachedHasLanguagesTable = false;
        }
    }
    ...
    public static function clearCache(): void
    {
        ...
        self::$cachedDefault = null;
        self::$cachedHasLanguagesTable = null;
    }
