...
class LanguageManagerServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        // Share languages with views that use engram layout (public), public layout (new), and language-manager
        view()->composer(['layouts.engram', 'layouts.public', 'language-manager::*'], function ($view) {
