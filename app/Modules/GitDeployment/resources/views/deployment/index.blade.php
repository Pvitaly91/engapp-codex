          ...
          <div class="space-y-2">
            ...
            @if(!empty($availableFolders))
              <div class="mt-3">
                ...
                <div id="folder-picker-ssh" class="hidden mt-2 p-3 rounded-xl border border-border/70 bg-muted/30 max-h-64 overflow-y-auto">
                  <div class="space-y-1">
                      ...
                      <div class="folder-tree-item">
                        <div class="flex items-center gap-1">
                          ...
                          <button 
                            ...
                            onclick="addFolderToTextarea('partial-deploy-paths', '{{ $parentFolder }}')"
                          >
                          ...
                          <div class="folder-children hidden ml-5 mt-1 space-y-0.5 border-l border-border/50 pl-2">
                            @foreach($children as $child)
                              <button 
                                ...
                                onclick="addFolderToTextarea('partial-deploy-paths', '{{ $parentFolder }}/{{ $child }}')"
                              >
