...
Модуль додає в адмінку сторінку `/admin/migrations` з можливістю запускати усі доступні міграції, робити rollback останньої партії та переглядати/очищати записи з таблиці `migrations` без доступу до консолі.
