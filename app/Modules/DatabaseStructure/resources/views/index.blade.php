...
@section('content')
  ...
  >
    ...
    <div class="mt-6 inline-flex items-center gap-2 rounded-full border border-border/60 bg-background/70 p-1 text-xs font-semibold text-muted-foreground">
      <button
        type="button"
        class="rounded-full px-4 py-1.5 transition focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/50"
        :class="activeTab === 'structure' ? 'bg-primary/10 text-primary shadow-sm' : 'text-muted-foreground hover:text-foreground'"
      ...
      <button
        type="button"
        class="rounded-full px-4 py-1.5 transition focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/50"
        :class="activeTab === 'content-management' ? 'bg-primary/10 text-primary shadow-sm' : 'text-muted-foreground hover:text-foreground'"
        @click="activeTab = 'content-management'"
      >
        Content Management
      </button>
    </div>
    ...
    <div x-show="activeTab === 'content-management'" x-cloak>
