...
{
    private static ?bool $hasQuestionsTable = null;
    ...
    {
        if (! $this->hasQuestionSeederColumn()) {
            return $baseScore;
        }
    ...
    private function hasQuestionsTable(): bool
    {
        return self::$hasQuestionsTable ??= Schema::hasTable('questions');
    }

    private function hasQuestionTagTable(): bool
    {
    ...
    private function hasQuestionSeederColumn(): bool
    {
