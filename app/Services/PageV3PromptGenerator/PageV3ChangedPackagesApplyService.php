...
class PageV3ChangedPackagesApplyService extends AbstractJsonPackageChangedApplyService
{
    public function __construct(
        private readonly PageV3ChangedPackagesPlanService $changedPackagesPlanService,
        private readonly PageV3DeletedPackageCleanupService $deletedPackageCleanupService,
    ...
    {
        return 'changed-package-apply-reports/page-v3';
    }
}
