...
class V3DestroyFolderFilesCommand extends Command
{
    protected $signature = 'v3:destroy-folder-files
        ...
        {--write-report : Write a compact report into storage/app/folder-file-destroy-reports/v3}
    ...
    protected $description = 'Delete only package-owned V3 JSON files inside one resolved subtree without touching DB rows or seed_runs.';

    public function __construct(
        private readonly V3FolderDestroyFilesService $folderDestroyFilesService,
    ) {
        parent::__construct();
    }
    ...
    private function renderHumanOutput(array $result): void
    {
        ...
        $this->line('Command: v3:destroy-folder-files');
