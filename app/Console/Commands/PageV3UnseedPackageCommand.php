...
class PageV3UnseedPackageCommand extends Command
{
    protected $signature = 'page-v3:unseed-package
        ...
        {--write-report : Write a Markdown report into storage/app/package-unseed-reports/page-v3}
        {--strict : Treat warnings as failures}';

    protected $description = 'Unseed a single resolved Page_V3 JSON package from the database without touching package files.';
