...
class V3PlanFolderCommand extends Command
{
    protected $signature = 'v3:plan-folder
        ...
        {--write-report : Write a Markdown report into storage/app/folder-plans/v3}
        {--strict : Treat planner warnings and inconsistent states as failures}';

    protected $description = 'Build a read-only execution plan for one resolved V3 subtree without seeding, refreshing, or deleting.';
    ...
    private function renderHumanOutput(array $result): void
    {
        ...
        $this->line('Command: v3:plan-folder');
