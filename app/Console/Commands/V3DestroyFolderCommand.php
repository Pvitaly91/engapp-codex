...
class V3DestroyFolderCommand extends Command
{
    protected $signature = 'v3:destroy-folder
        ...
        {--write-report : Write a compact report into storage/app/folder-destroy-reports/v3}
    ...
    protected $description = 'Destroy one resolved V3 subtree by running DB cleanup first and package file cleanup second.';

    public function __construct(
        private readonly V3FolderDestroyService $folderDestroyService,
    ) {
        parent::__construct();
    }
    ...
    private function renderHumanOutput(array $result): void
    {
        ...
        $this->line('Command: v3:destroy-folder');
