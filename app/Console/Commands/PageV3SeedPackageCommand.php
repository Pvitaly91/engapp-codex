...
class PageV3SeedPackageCommand extends Command
{
    protected $signature = 'page-v3:seed-package
    ...
    protected $description = 'Seed a single resolved Page_V3 JSON package with optional preflight gating and dry-run rollback.';
