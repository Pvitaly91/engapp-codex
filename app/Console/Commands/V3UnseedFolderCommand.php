...
class V3UnseedFolderCommand extends Command
{
    protected $signature = 'v3:unseed-folder
        ...
        {--write-report : Write a Markdown report into storage/app/folder-unseed-reports/v3}
        {--strict : Treat planner or preflight warnings as failures}';

    protected $description = 'Unseed one resolved V3 subtree from the database using planner-driven preflight and package-by-package delete execution.';

    public function __construct(
        private readonly V3FolderUnseedService $folderUnseedService,
    ) {
        parent::__construct();
    }
    ...
    private function renderHumanOutput(array $result): void
    {
        ...
        $this->line('Command: v3:unseed-folder');
