...
class V3RefreshPackageCommand extends Command
{
    protected $signature = 'v3:refresh-package
        ...
        {--write-report : Write a Markdown report into storage/app/package-refresh-reports/v3}
    ...
    protected $description = 'Refresh a single resolved V3 JSON package with atomic live refresh, rollback-only dry run, and release-check gating.';
