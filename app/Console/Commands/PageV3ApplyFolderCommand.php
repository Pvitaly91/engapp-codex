...
class PageV3ApplyFolderCommand extends Command
{
    protected $signature = 'page-v3:apply-folder
        ...
        {--write-report : Write a Markdown report into storage/app/folder-apply-reports/page-v3}
    ...
    protected $description = 'Apply planner-ordered seed/refresh actions for one resolved Page_V3 subtree without scanning outside scope.';

    public function __construct(
        private readonly PageV3FolderApplyService $folderApplyService,
    ) {
        parent::__construct();
    }
    ...
    private function renderHumanOutput(array $result): void
    {
        ...
        $this->line('Command: page-v3:apply-folder');
