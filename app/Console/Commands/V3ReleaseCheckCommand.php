...
class V3ReleaseCheckCommand extends Command
{
    protected $signature = 'v3:release-check
        ...
        {--write-report : Write a Markdown report into storage/app/release-checks/v3}
        {--strict : Treat warnings as failures}';

    protected $description = 'Run preflight release checks for a single V3 JSON package without seeding the database.';
