...
Повний перелік фактичних питань локальної БД, для яких механізм застосовується, наведено у [згенерованому інвентарі](english-contractions-questions.md). На момент генерації це 3011 питань; для кожного вказано ID, категорію, текст, маркер і канонічну відповідь.
