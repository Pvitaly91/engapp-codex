...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | When enabled, a "BETA" badge will be shown next to the logo and a
    | beta banner will be displayed on the home page.
    |
    */
    ...
    */
    ...
    'providers' => ServiceProvider::defaultProviders()->merge([
        ...
        App\Modules\SeedRunsV2\SeedRunsV2ServiceProvider::class,
    ])->toArray(),
