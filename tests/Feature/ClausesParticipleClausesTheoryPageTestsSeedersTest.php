...
use Database\Seeders\Page_V3\ClausesAndLinkingWords\AdvancedParticipleAndAbsoluteClausesTheorySeeder;
use Database\Seeders\Page_V3\ClausesAndLinkingWords\ClausesAndLinkingWordsCategorySeeder;
use Database\Seeders\Page_V3\ClausesAndLinkingWords\ParticipleClausesBasicsTheorySeeder;
use Database\Seeders\Page_V3\ClausesAndLinkingWords\ParticipleClausesTheorySeeder;
use Database\Seeders\V3\ClausesAndLinkingWords\AdvancedParticipleAndAbsoluteClausesAllLevelsV3Seeder;
use Database\Seeders\V3\ClausesAndLinkingWords\ParticipleClausesAllLevelsV3Seeder;
use Database\Seeders\V3\ClausesAndLinkingWords\ParticipleClausesBasicsAllLevelsV3Seeder;
use Database\Seeders\V3\Polyglot\PolyglotAdvancedParticipleAndAbsoluteClausesAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotAdvancedParticipleAndAbsoluteClausesC2LessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotParticipleClausesAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotParticipleClausesBasicsAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotParticipleClausesBasicsB2LessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotParticipleClausesC1LessonSeeder;
use Database\Seeders\V3\TheoryLinks\AdvancedParticipleAndAbsoluteClausesTheoryLinksSeeder;
use Database\Seeders\V3\TheoryLinks\ParticipleClausesBasicsTheoryLinksSeeder;
use Database\Seeders\V3\TheoryLinks\ParticipleClausesTheoryLinksSeeder;
...
class ClausesParticipleClausesTheoryPageTestsSeedersTest extends TestCase
{
    ...
    public function test_participle_clause_pages_have_tests_and_theory_links(): void
    {
        $this->seedParticipleClausesStack();

        $this->seed([
            ParticipleClausesBasicsTheoryLinksSeeder::class,
            ParticipleClausesTheoryLinksSeeder::class,
            AdvancedParticipleAndAbsoluteClausesTheoryLinksSeeder::class,
        ]);
        ...
        $this->assertAuditReportsParticipleClauseRoutesAsOk();
    }

    private function seedParticipleClausesStack(): void
    {
        $this->seed([
            ClausesAndLinkingWordsCategorySeeder::class,
            ParticipleClausesBasicsTheorySeeder::class,
            ParticipleClausesTheorySeeder::class,
            AdvancedParticipleAndAbsoluteClausesTheorySeeder::class,
            ParticipleClausesBasicsAllLevelsV3Seeder::class,
            ParticipleClausesAllLevelsV3Seeder::class,
            AdvancedParticipleAndAbsoluteClausesAllLevelsV3Seeder::class,
            PolyglotParticipleClausesBasicsAllLevelsLessonSeeder::class,
            PolyglotParticipleClausesAllLevelsLessonSeeder::class,
            PolyglotAdvancedParticipleAndAbsoluteClausesAllLevelsLessonSeeder::class,
            PolyglotParticipleClausesBasicsB2LessonSeeder::class,
            PolyglotParticipleClausesC1LessonSeeder::class,
            PolyglotAdvancedParticipleAndAbsoluteClausesC2LessonSeeder::class,
        ]);
    }
    ...
    {
        return [
            'participle-clauses-basics' => [
                'route' => '/theory/clauses-and-linking-words/participle-clauses-basics',
                'page_slug' => 'participle-clauses-basics',
                'direct_slug' => 'polyglot-participle-clauses-basics-all-levels',
                'v3_seeder' => ParticipleClausesBasicsAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotParticipleClausesBasicsAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [ParticipleClausesBasicsAllLevelsV3Seeder::class, PolyglotParticipleClausesBasicsAllLevelsLessonSeeder::class],
                'covered_seeders' => [ParticipleClausesBasicsAllLevelsV3Seeder::class, PolyglotParticipleClausesBasicsAllLevelsLessonSeeder::class, PolyglotParticipleClausesBasicsB2LessonSeeder::class],
                'links_seeder' => ParticipleClausesBasicsTheoryLinksSeeder::class,
                'covered_seeder_counts' => [PolyglotParticipleClausesBasicsB2LessonSeeder::class => 48],
            ],
            'participle-clauses' => [
                'route' => '/theory/clauses-and-linking-words/participle-clauses',
                'page_slug' => 'participle-clauses',
                'direct_slug' => 'polyglot-participle-clauses-all-levels',
                'v3_seeder' => ParticipleClausesAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotParticipleClausesAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [ParticipleClausesAllLevelsV3Seeder::class, PolyglotParticipleClausesAllLevelsLessonSeeder::class],
                'covered_seeders' => [ParticipleClausesAllLevelsV3Seeder::class, PolyglotParticipleClausesAllLevelsLessonSeeder::class, PolyglotParticipleClausesC1LessonSeeder::class],
                'links_seeder' => ParticipleClausesTheoryLinksSeeder::class,
                'covered_seeder_counts' => [PolyglotParticipleClausesC1LessonSeeder::class => 48],
            ],
            'advanced-participle-and-absolute-clauses' => [
                'route' => '/theory/clauses-and-linking-words/advanced-participle-and-absolute-clauses',
                'page_slug' => 'advanced-participle-and-absolute-clauses',
                'direct_slug' => 'polyglot-advanced-participle-and-absolute-clauses-all-levels',
                'v3_seeder' => AdvancedParticipleAndAbsoluteClausesAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotAdvancedParticipleAndAbsoluteClausesAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [AdvancedParticipleAndAbsoluteClausesAllLevelsV3Seeder::class, PolyglotAdvancedParticipleAndAbsoluteClausesAllLevelsLessonSeeder::class],
                'covered_seeders' => [AdvancedParticipleAndAbsoluteClausesAllLevelsV3Seeder::class, PolyglotAdvancedParticipleAndAbsoluteClausesAllLevelsLessonSeeder::class, PolyglotAdvancedParticipleAndAbsoluteClausesC2LessonSeeder::class],
                'links_seeder' => AdvancedParticipleAndAbsoluteClausesTheoryLinksSeeder::class,
                'covered_seeder_counts' => [PolyglotAdvancedParticipleAndAbsoluteClausesC2LessonSeeder::class => 48],
            ],
        ];
    }
    ...
    private function assertAuditReportsParticipleClauseRoutesAsOk(): void
    {
        $jsonPath = storage_path('framework/testing/clauses-participle-clauses-theory-links-audit.json');
        $markdownPath = storage_path('framework/testing/clauses-participle-clauses-theory-links-audit.md');
