...
use Database\Seeders\Page_V3\RelativeClauses\ComplexRelativeClausesTheorySeeder;
use Database\Seeders\V3\Polyglot\PolyglotComplexRelativeClausesAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotComplexRelativeClausesC1LessonSeeder;
use Database\Seeders\V3\RelativeClauses\ComplexRelativeClausesAllLevelsV3Seeder;
use Database\Seeders\V3\TheoryLinks\ComplexRelativeClausesTheoryLinksSeeder;
...
class ComplexRelativeClausesTheoryPageTestsSeedersTest extends TestCase
{
    ...
    public function test_complex_relative_clauses_page_has_tests_and_theory_links(): void
    {
        $this->seedComplexRelativeClausesStack();
        $this->seed(ComplexRelativeClausesTheoryLinksSeeder::class);
        ...
        $this->assertEveryCoveredQuestionHasTheoryLinks($case['covered_seeders'], $case['covered_seeder_counts']);
        ...
        $this->assertAuditReportsComplexRelativeClausesRouteAsOk();
    }

    private function seedComplexRelativeClausesStack(): void
    {
        $this->seed([
            ComplexRelativeClausesTheorySeeder::class,
            ComplexRelativeClausesAllLevelsV3Seeder::class,
            PolyglotComplexRelativeClausesAllLevelsLessonSeeder::class,
            PolyglotComplexRelativeClausesC1LessonSeeder::class,
        ]);
    }
    ...
    {
        return [
            'route' => '/theory/relative-clauses/complex-relative-clauses',
            'page_slug' => 'complex-relative-clauses',
            'direct_slug' => 'polyglot-complex-relative-clauses-all-levels',
            'v3_seeder' => ComplexRelativeClausesAllLevelsV3Seeder::class,
            'polyglot_seeder' => PolyglotComplexRelativeClausesAllLevelsLessonSeeder::class,
            'mixed_filter_seeders' => [ComplexRelativeClausesAllLevelsV3Seeder::class, PolyglotComplexRelativeClausesAllLevelsLessonSeeder::class],
            'covered_seeders' => [ComplexRelativeClausesAllLevelsV3Seeder::class, PolyglotComplexRelativeClausesAllLevelsLessonSeeder::class, PolyglotComplexRelativeClausesC1LessonSeeder::class],
            'covered_seeder_counts' => [PolyglotComplexRelativeClausesC1LessonSeeder::class => 48],
        ];
    }
    ...
    private function assertEveryCoveredQuestionHasTheoryLinks(array $seederClasses, array $expectedCounts): void
    {
        ...
        foreach ($seederClasses as $seederClass) {
            $this->assertSame((int) ($expectedCounts[$seederClass] ?? 72), $questions->where('seeder', $seederClass)->count(), $seederClass);
        }
    ...
    private function assertDirectSentenceBuilderQuestionsExposeTheoryBlocks(string $directSlug, string $polyglotSeeder): void
    {
        ...
        $this->assertTrue($questions->every(fn (Question $question): bool => (string) $question->seeder === $polyglotSeeder), 'direct Sentence Builder should use only the page-local all-levels Polyglot seeder.');
    ...
    private function assertAuditReportsComplexRelativeClausesRouteAsOk(): void
    {
        $jsonPath = storage_path('framework/testing/complex-relative-clauses-theory-links-audit.json');
        $markdownPath = storage_path('framework/testing/complex-relative-clauses-theory-links-audit.md');
        ...
        $row = collect($audit['pages'] ?? [])->firstWhere('route', '/theory/relative-clauses/complex-relative-clauses');
