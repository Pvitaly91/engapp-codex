...
use Database\Seeders\Page_V3\PassiveVoice\Basics\PassiveVoiceCausativeTheorySeeder;
use Database\Seeders\Page_V3\PassiveVoice\Basics\PassiveVoiceFormalityStyleTheorySeeder;
use Database\Seeders\Page_V3\PassiveVoice\Basics\PassiveVoiceImpersonalPassiveTheorySeeder;
use Database\Seeders\Page_V3\PassiveVoice\PassiveVoiceCategorySeeder;
use Database\Seeders\Page_V3\PassiveVoice\SpecialCases\PassiveVoiceByPhraseTheorySeeder;
use Database\Seeders\V3\PassiveVoice\PassiveVoiceByPhraseAllLevelsV3Seeder;
use Database\Seeders\V3\PassiveVoice\PassiveVoiceCausativeAllLevelsV3Seeder;
use Database\Seeders\V3\PassiveVoice\PassiveVoiceFormalityStyleAllLevelsV3Seeder;
use Database\Seeders\V3\PassiveVoice\PassiveVoiceImpersonalPassiveAllLevelsV3Seeder;
use Database\Seeders\V3\Polyglot\PolyglotCausativeHaveGetLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotPassiveVoiceByPhraseAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotPassiveVoiceCausativeAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotPassiveVoiceFormalityStyleAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotPassiveVoiceImpersonalPassiveAllLevelsLessonSeeder;
use Database\Seeders\V3\TheoryLinks\PassiveVoiceByPhraseTheoryLinksSeeder;
use Database\Seeders\V3\TheoryLinks\PassiveVoiceCausativeTheoryLinksSeeder;
use Database\Seeders\V3\TheoryLinks\PassiveVoiceFormalityStyleTheoryLinksSeeder;
use Database\Seeders\V3\TheoryLinks\PassiveVoiceImpersonalPassiveTheoryLinksSeeder;
...
class PassiveVoiceSpecialTheoryPageTestsSeedersTest extends TestCase
{
    ...
    public function test_passive_voice_special_pages_have_tests_and_theory_links(): void
    {
        $this->seedPassiveVoiceSpecialStack();

        $this->seed([
            PassiveVoiceFormalityStyleTheoryLinksSeeder::class,
            PassiveVoiceByPhraseTheoryLinksSeeder::class,
            PassiveVoiceCausativeTheoryLinksSeeder::class,
            PassiveVoiceImpersonalPassiveTheoryLinksSeeder::class,
        ]);
        ...
        $this->assertAuditReportsPassiveVoiceSpecialRoutesAsOk();
    }

    private function seedPassiveVoiceSpecialStack(): void
    {
        $this->seed([
            PassiveVoiceCategorySeeder::class,
            PassiveVoiceFormalityStyleTheorySeeder::class,
            PassiveVoiceByPhraseTheorySeeder::class,
            PassiveVoiceCausativeTheorySeeder::class,
            PassiveVoiceImpersonalPassiveTheorySeeder::class,
            PassiveVoiceFormalityStyleAllLevelsV3Seeder::class,
            PassiveVoiceByPhraseAllLevelsV3Seeder::class,
            PassiveVoiceCausativeAllLevelsV3Seeder::class,
            PassiveVoiceImpersonalPassiveAllLevelsV3Seeder::class,
            PolyglotPassiveVoiceFormalityStyleAllLevelsLessonSeeder::class,
            PolyglotPassiveVoiceByPhraseAllLevelsLessonSeeder::class,
            PolyglotCausativeHaveGetLessonSeeder::class,
            PolyglotPassiveVoiceCausativeAllLevelsLessonSeeder::class,
            PolyglotPassiveVoiceImpersonalPassiveAllLevelsLessonSeeder::class,
        ]);
    }
    ...
    private function cases(): array
    {
        return [
            'formality-style' => [
                'route' => '/theory/passive-voice/theory-passive-voice-formality-style',
                'page_slug' => 'theory-passive-voice-formality-style',
                'direct_slug' => 'polyglot-passive-voice-formality-style-all-levels',
                'v3_seeder' => PassiveVoiceFormalityStyleAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotPassiveVoiceFormalityStyleAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [PassiveVoiceFormalityStyleAllLevelsV3Seeder::class, PolyglotPassiveVoiceFormalityStyleAllLevelsLessonSeeder::class],
                'covered_seeders' => [PassiveVoiceFormalityStyleAllLevelsV3Seeder::class, PolyglotPassiveVoiceFormalityStyleAllLevelsLessonSeeder::class],
                'links_seeder' => PassiveVoiceFormalityStyleTheoryLinksSeeder::class,
            ],
            'by-phrase' => [
                'route' => '/theory/passive-voice/theory-passive-voice-by-phrase',
                'page_slug' => 'theory-passive-voice-by-phrase',
                'direct_slug' => 'polyglot-passive-voice-by-phrase-all-levels',
                'v3_seeder' => PassiveVoiceByPhraseAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotPassiveVoiceByPhraseAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [PassiveVoiceByPhraseAllLevelsV3Seeder::class, PolyglotPassiveVoiceByPhraseAllLevelsLessonSeeder::class],
                'covered_seeders' => [PassiveVoiceByPhraseAllLevelsV3Seeder::class, PolyglotPassiveVoiceByPhraseAllLevelsLessonSeeder::class],
                'links_seeder' => PassiveVoiceByPhraseTheoryLinksSeeder::class,
            ],
            'causative' => [
                'route' => '/theory/passive-voice/theory-passive-voice-causative',
                'page_slug' => 'theory-passive-voice-causative',
                'direct_slug' => 'polyglot-passive-voice-causative-all-levels',
                'v3_seeder' => PassiveVoiceCausativeAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotPassiveVoiceCausativeAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [PassiveVoiceCausativeAllLevelsV3Seeder::class, PolyglotPassiveVoiceCausativeAllLevelsLessonSeeder::class],
                'covered_seeders' => [PassiveVoiceCausativeAllLevelsV3Seeder::class, PolyglotPassiveVoiceCausativeAllLevelsLessonSeeder::class, PolyglotCausativeHaveGetLessonSeeder::class],
                'covered_question_counts' => [PolyglotCausativeHaveGetLessonSeeder::class => 48],
                'links_seeder' => PassiveVoiceCausativeTheoryLinksSeeder::class,
            ],
            'impersonal-passive' => [
                'route' => '/theory/passive-voice/theory-passive-voice-impersonal-passive',
                'page_slug' => 'theory-passive-voice-impersonal-passive',
                'direct_slug' => 'polyglot-passive-voice-impersonal-passive-all-levels',
                'v3_seeder' => PassiveVoiceImpersonalPassiveAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotPassiveVoiceImpersonalPassiveAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [PassiveVoiceImpersonalPassiveAllLevelsV3Seeder::class, PolyglotPassiveVoiceImpersonalPassiveAllLevelsLessonSeeder::class],
                'covered_seeders' => [PassiveVoiceImpersonalPassiveAllLevelsV3Seeder::class, PolyglotPassiveVoiceImpersonalPassiveAllLevelsLessonSeeder::class],
                'links_seeder' => PassiveVoiceImpersonalPassiveTheoryLinksSeeder::class,
            ],
        ];
    }
    ...
    private function assertAuditReportsPassiveVoiceSpecialRoutesAsOk(): void
    {
        $jsonPath = storage_path('framework/testing/passive-voice-special-theory-links-audit.json');
        $markdownPath = storage_path('framework/testing/passive-voice-special-theory-links-audit.md');
