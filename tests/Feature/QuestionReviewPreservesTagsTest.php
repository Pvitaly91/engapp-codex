...
class QuestionReviewPreservesTagsTest extends TestCase
{
    /** @test */
    public function saving_review_keeps_ai_and_other_category_tags(): void
    {
        $migrations = [
        ...
        $answer = new QuestionAnswer(['marker' => 'a1']);
        $answer->question_id = $question->id;
        $answer->answer = 'yes';
        $answer->save();

        $aiTag = Tag::create(['name' => 'AI tag', 'category' => 'AI']);
        $otherTag = Tag::create(['name' => 'Other tag', 'category' => 'Others']);
        $newTag = Tag::create(['name' => 'New tag', 'category' => 'Grammar']);
