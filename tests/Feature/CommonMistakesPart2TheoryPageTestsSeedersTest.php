...
use Database\Seeders\Page_V3\CommonMistakes\CommonMistakesB1B2GrammarTrapsTheorySeeder;
use Database\Seeders\Page_V3\CommonMistakes\CommonMistakesCategorySeeder;
use Database\Seeders\Page_V3\CommonMistakes\CommonMistakesPresentPerfectTheorySeeder;
use Database\Seeders\V3\CommonMistakes\CommonMistakesB1B2GrammarTrapsAllLevelsV3Seeder;
use Database\Seeders\V3\CommonMistakes\CommonMistakesPresentPerfectAllLevelsV3Seeder;
use Database\Seeders\V3\Polyglot\PolyglotCommonMistakesB1B2GrammarTrapsAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotCommonMistakesPresentPerfectAllLevelsLessonSeeder;
use Database\Seeders\V3\TheoryLinks\CommonMistakesB1B2GrammarTrapsTheoryLinksSeeder;
use Database\Seeders\V3\TheoryLinks\CommonMistakesPresentPerfectTheoryLinksSeeder;
...
class CommonMistakesPart2TheoryPageTestsSeedersTest extends TestCase
{
    ...
    public function test_common_mistakes_part_two_pages_have_tests_and_theory_links(): void
    {
        $this->seedCommonMistakesPartTwoStack();

        $this->seed([
            CommonMistakesPresentPerfectTheoryLinksSeeder::class,
            CommonMistakesB1B2GrammarTrapsTheoryLinksSeeder::class,
        ]);
        ...
        $this->assertAuditReportsCommonMistakesPartTwoRoutesAsOk();
    }

    private function seedCommonMistakesPartTwoStack(): void
    {
        $this->seed([
            CommonMistakesCategorySeeder::class,
            CommonMistakesPresentPerfectTheorySeeder::class,
            CommonMistakesB1B2GrammarTrapsTheorySeeder::class,
            CommonMistakesPresentPerfectAllLevelsV3Seeder::class,
            CommonMistakesB1B2GrammarTrapsAllLevelsV3Seeder::class,
            PolyglotCommonMistakesPresentPerfectAllLevelsLessonSeeder::class,
            PolyglotCommonMistakesB1B2GrammarTrapsAllLevelsLessonSeeder::class,
        ]);
    }
    ...
    private function cases(): array
    {
        return [
            'present-perfect-common-mistakes' => [
                'route' => '/theory/common-mistakes/present-perfect-common-mistakes',
                'page_slug' => 'present-perfect-common-mistakes',
                'direct_slug' => 'polyglot-common-mistakes-present-perfect-all-levels',
                'v3_seeder' => CommonMistakesPresentPerfectAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotCommonMistakesPresentPerfectAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [CommonMistakesPresentPerfectAllLevelsV3Seeder::class, PolyglotCommonMistakesPresentPerfectAllLevelsLessonSeeder::class],
                'covered_seeders' => [CommonMistakesPresentPerfectAllLevelsV3Seeder::class, PolyglotCommonMistakesPresentPerfectAllLevelsLessonSeeder::class],
                'links_seeder' => CommonMistakesPresentPerfectTheoryLinksSeeder::class,
            ],
            'b1-b2-grammar-traps' => [
                'route' => '/theory/common-mistakes/b1-b2-grammar-traps',
                'page_slug' => 'b1-b2-grammar-traps',
                'direct_slug' => 'polyglot-common-mistakes-b1-b2-grammar-traps-all-levels',
                'v3_seeder' => CommonMistakesB1B2GrammarTrapsAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotCommonMistakesB1B2GrammarTrapsAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [CommonMistakesB1B2GrammarTrapsAllLevelsV3Seeder::class, PolyglotCommonMistakesB1B2GrammarTrapsAllLevelsLessonSeeder::class],
                'covered_seeders' => [CommonMistakesB1B2GrammarTrapsAllLevelsV3Seeder::class, PolyglotCommonMistakesB1B2GrammarTrapsAllLevelsLessonSeeder::class],
                'links_seeder' => CommonMistakesB1B2GrammarTrapsTheoryLinksSeeder::class,
            ],
        ];
    }
    ...
    private function assertAuditReportsCommonMistakesPartTwoRoutesAsOk(): void
    {
        $jsonPath = storage_path('framework/testing/common-mistakes-part-2-theory-links-audit.json');
        $markdownPath = storage_path('framework/testing/common-mistakes-part-2-theory-links-audit.md');
