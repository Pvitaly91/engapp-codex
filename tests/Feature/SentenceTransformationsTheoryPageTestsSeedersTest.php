...
use Database\Seeders\Page_V3\SentenceTransformations\SentenceTransformationsConditionalsTheorySeeder;
use Database\Seeders\Page_V3\SentenceTransformations\SentenceTransformationsModalsTheorySeeder;
use Database\Seeders\Page_V3\SentenceTransformations\SentenceTransformationsPassiveTheorySeeder;
use Database\Seeders\Page_V3\SentenceTransformations\SentenceTransformationsTensesTheorySeeder;
use Database\Seeders\V3\Polyglot\PolyglotSentenceTransformationsConditionalsAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotSentenceTransformationsModalsAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotSentenceTransformationsPassiveAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotSentenceTransformationsTensesAllLevelsLessonSeeder;
use Database\Seeders\V3\SentenceTransformations\SentenceTransformationsConditionalsAllLevelsV3Seeder;
use Database\Seeders\V3\SentenceTransformations\SentenceTransformationsModalsAllLevelsV3Seeder;
use Database\Seeders\V3\SentenceTransformations\SentenceTransformationsPassiveAllLevelsV3Seeder;
use Database\Seeders\V3\SentenceTransformations\SentenceTransformationsTensesAllLevelsV3Seeder;
use Database\Seeders\V3\TheoryLinks\SentenceTransformationsConditionalsTheoryLinksSeeder;
use Database\Seeders\V3\TheoryLinks\SentenceTransformationsModalsTheoryLinksSeeder;
use Database\Seeders\V3\TheoryLinks\SentenceTransformationsPassiveTheoryLinksSeeder;
use Database\Seeders\V3\TheoryLinks\SentenceTransformationsTensesTheoryLinksSeeder;
...
class SentenceTransformationsTheoryPageTestsSeedersTest extends TestCase
{
    ...
    public function test_sentence_transformations_pages_have_tests_and_theory_links(): void
    {
        $this->seedSentenceTransformationsStack();

        $this->seed([
            SentenceTransformationsTensesTheoryLinksSeeder::class,
            SentenceTransformationsPassiveTheoryLinksSeeder::class,
            SentenceTransformationsModalsTheoryLinksSeeder::class,
            SentenceTransformationsConditionalsTheoryLinksSeeder::class,
        ]);
        ...
        $this->assertAuditReportsSentenceTransformationsRoutesAsOk();
    }

    private function seedSentenceTransformationsStack(): void
    {
        $this->seed([
            SentenceTransformationsCategorySeeder::class,
            SentenceTransformationsTensesTheorySeeder::class,
            SentenceTransformationsPassiveTheorySeeder::class,
            SentenceTransformationsModalsTheorySeeder::class,
            SentenceTransformationsConditionalsTheorySeeder::class,
            SentenceTransformationsTensesAllLevelsV3Seeder::class,
            SentenceTransformationsPassiveAllLevelsV3Seeder::class,
            SentenceTransformationsModalsAllLevelsV3Seeder::class,
            SentenceTransformationsConditionalsAllLevelsV3Seeder::class,
            PolyglotSentenceTransformationsTensesAllLevelsLessonSeeder::class,
            PolyglotSentenceTransformationsPassiveAllLevelsLessonSeeder::class,
            PolyglotSentenceTransformationsModalsAllLevelsLessonSeeder::class,
            PolyglotSentenceTransformationsConditionalsAllLevelsLessonSeeder::class,
        ]);
    }
    ...
    private function cases(): array
    {
        return [
            'tenses' => [
                'route' => '/theory/sentence-transformations/tenses',
                'page_slug' => 'tenses',
                'direct_slug' => 'polyglot-sentence-transformations-tenses-all-levels',
                'v3_seeder' => SentenceTransformationsTensesAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotSentenceTransformationsTensesAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [SentenceTransformationsTensesAllLevelsV3Seeder::class, PolyglotSentenceTransformationsTensesAllLevelsLessonSeeder::class],
                'covered_seeders' => [SentenceTransformationsTensesAllLevelsV3Seeder::class, PolyglotSentenceTransformationsTensesAllLevelsLessonSeeder::class],
                'links_seeder' => SentenceTransformationsTensesTheoryLinksSeeder::class,
            ],
            'passive' => [
                'route' => '/theory/sentence-transformations/passive',
                'page_slug' => 'passive',
                'direct_slug' => 'polyglot-sentence-transformations-passive-all-levels',
                'v3_seeder' => SentenceTransformationsPassiveAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotSentenceTransformationsPassiveAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [SentenceTransformationsPassiveAllLevelsV3Seeder::class, PolyglotSentenceTransformationsPassiveAllLevelsLessonSeeder::class],
                'covered_seeders' => [SentenceTransformationsPassiveAllLevelsV3Seeder::class, PolyglotSentenceTransformationsPassiveAllLevelsLessonSeeder::class],
                'links_seeder' => SentenceTransformationsPassiveTheoryLinksSeeder::class,
            ],
            'modals' => [
                'route' => '/theory/sentence-transformations/modals',
                'page_slug' => 'modals',
                'direct_slug' => 'polyglot-sentence-transformations-modals-all-levels',
                'v3_seeder' => SentenceTransformationsModalsAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotSentenceTransformationsModalsAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [SentenceTransformationsModalsAllLevelsV3Seeder::class, PolyglotSentenceTransformationsModalsAllLevelsLessonSeeder::class],
                'covered_seeders' => [SentenceTransformationsModalsAllLevelsV3Seeder::class, PolyglotSentenceTransformationsModalsAllLevelsLessonSeeder::class],
                'links_seeder' => SentenceTransformationsModalsTheoryLinksSeeder::class,
            ],
            'conditionals' => [
                'route' => '/theory/sentence-transformations/conditionals',
                'page_slug' => 'conditionals',
                'direct_slug' => 'polyglot-sentence-transformations-conditionals-all-levels',
                'v3_seeder' => SentenceTransformationsConditionalsAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotSentenceTransformationsConditionalsAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [SentenceTransformationsConditionalsAllLevelsV3Seeder::class, PolyglotSentenceTransformationsConditionalsAllLevelsLessonSeeder::class],
                'covered_seeders' => [SentenceTransformationsConditionalsAllLevelsV3Seeder::class, PolyglotSentenceTransformationsConditionalsAllLevelsLessonSeeder::class],
                'links_seeder' => SentenceTransformationsConditionalsTheoryLinksSeeder::class,
            ],
        ];
    }
    ...
    private function assertAuditReportsSentenceTransformationsRoutesAsOk(): void
    {
        $jsonPath = storage_path('framework/testing/sentence-transformations-theory-links-audit.json');
        $markdownPath = storage_path('framework/testing/sentence-transformations-theory-links-audit.md');
