...
use Database\Seeders\Page_V3\Tenses\PresentPerfect\PresentPerfectNegativesTheorySeeder;
use Database\Seeders\Page_V3\Tenses\PresentPerfect\PresentPerfectQuestionsTheorySeeder;
...
use Database\Seeders\V3\Polyglot\PolyglotPresentPerfectFormsAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotPresentPerfectNegativesAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotPresentPerfectQuestionsAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotPresentPerfectTimeExpressionsAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotPresentPerfectTimeExpressionsLessonSeeder;
use Database\Seeders\V3\Tenses\PresentPerfect\PresentPerfectFormsAllLevelsV3Seeder;
use Database\Seeders\V3\Tenses\PresentPerfect\PresentPerfectNegativesAllLevelsV3Seeder;
use Database\Seeders\V3\Tenses\PresentPerfect\PresentPerfectQuestionsAllLevelsV3Seeder;
use Database\Seeders\V3\Tenses\PresentPerfect\PresentPerfectTimeExpressionsAllLevelsV3Seeder;
use Database\Seeders\V3\TheoryLinks\PresentPerfectFormsTheoryLinksSeeder;
use Database\Seeders\V3\TheoryLinks\PresentPerfectNegativesTheoryLinksSeeder;
use Database\Seeders\V3\TheoryLinks\PresentPerfectQuestionsTheoryLinksSeeder;
use Database\Seeders\V3\TheoryLinks\PresentPerfectTimeExpressionsTheoryLinksSeeder;
...
class PresentPerfectTheoryPageTestsSeedersTest extends TestCase
{
    ...
    public function test_present_perfect_pages_have_tests_and_theory_links(): void
    {
        $this->seedPresentPerfectStack();

        $this->seed([
            PresentPerfectFormsTheoryLinksSeeder::class,
            PresentPerfectNegativesTheoryLinksSeeder::class,
            PresentPerfectQuestionsTheoryLinksSeeder::class,
            PresentPerfectTimeExpressionsTheoryLinksSeeder::class,
        ]);
        ...
        $this->assertAuditReportsPresentPerfectRoutesAsOk();
    }

    private function seedPresentPerfectStack(): void
    {
        $this->seed([
            TensesCategorySeeder::class,
            PresentPerfectCategorySeeder::class,
            PresentPerfectFormsTheorySeeder::class,
            PresentPerfectNegativesTheorySeeder::class,
            PresentPerfectQuestionsTheorySeeder::class,
            PresentPerfectTimeExpressionsTheorySeeder::class,
            PresentPerfectFormsAllLevelsV3Seeder::class,
            PresentPerfectNegativesAllLevelsV3Seeder::class,
            PresentPerfectQuestionsAllLevelsV3Seeder::class,
            PresentPerfectTimeExpressionsAllLevelsV3Seeder::class,
            PolyglotPresentPerfectFormsAllLevelsLessonSeeder::class,
            PolyglotPresentPerfectNegativesAllLevelsLessonSeeder::class,
            PolyglotPresentPerfectQuestionsAllLevelsLessonSeeder::class,
            PolyglotPresentPerfectTimeExpressionsAllLevelsLessonSeeder::class,
            PolyglotPresentPerfectBasicLessonSeeder::class,
            PolyglotPresentPerfectTimeExpressionsLessonSeeder::class,
        ]);
    }
    ...
    private function cases(): array
    {
        return [
            'forms' => [
                'route' => '/theory/tenses/present-perfect/present-perfect-forms',
                'page_slug' => 'present-perfect-forms',
                'direct_slug' => 'polyglot-present-perfect-forms-all-levels',
                'v3_seeder' => PresentPerfectFormsAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotPresentPerfectFormsAllLevelsLessonSeeder::class,
                ...
                'covered_seeder_counts' => [
                    PresentPerfectFormsAllLevelsV3Seeder::class => 72,
                    PolyglotPresentPerfectFormsAllLevelsLessonSeeder::class => 72,
                    PolyglotPresentPerfectBasicLessonSeeder::class => 24,
                ],
                'links_seeder' => PresentPerfectFormsTheoryLinksSeeder::class,
            ],
            'negatives' => [
                'route' => '/theory/tenses/present-perfect/present-perfect-negatives',
                'page_slug' => 'present-perfect-negatives',
                'direct_slug' => 'polyglot-present-perfect-negatives-all-levels',
                'v3_seeder' => PresentPerfectNegativesAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotPresentPerfectNegativesAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [
                    PresentPerfectNegativesAllLevelsV3Seeder::class,
                    PolyglotPresentPerfectNegativesAllLevelsLessonSeeder::class,
                ],
                ...
                'links_seeder' => PresentPerfectNegativesTheoryLinksSeeder::class,
            ],
            'questions' => [
                'route' => '/theory/tenses/present-perfect/present-perfect-questions',
                'page_slug' => 'present-perfect-questions',
                'direct_slug' => 'polyglot-present-perfect-questions-all-levels',
                'v3_seeder' => PresentPerfectQuestionsAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotPresentPerfectQuestionsAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [
                    PresentPerfectQuestionsAllLevelsV3Seeder::class,
                    PolyglotPresentPerfectQuestionsAllLevelsLessonSeeder::class,
                ],
                ...
                'links_seeder' => PresentPerfectQuestionsTheoryLinksSeeder::class,
            ],
            'time_expressions' => [
                'route' => '/theory/tenses/present-perfect/present-perfect-time-expressions',
                'page_slug' => 'present-perfect-time-expressions',
                'direct_slug' => 'polyglot-present-perfect-time-expressions-all-levels',
                'v3_seeder' => PresentPerfectTimeExpressionsAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotPresentPerfectTimeExpressionsAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [
                    PresentPerfectTimeExpressionsAllLevelsV3Seeder::class,
                    PolyglotPresentPerfectTimeExpressionsAllLevelsLessonSeeder::class,
                ],
                ...
                'covered_seeder_counts' => [
                    PresentPerfectTimeExpressionsAllLevelsV3Seeder::class => 72,
                    PolyglotPresentPerfectTimeExpressionsAllLevelsLessonSeeder::class => 72,
                    PolyglotPresentPerfectTimeExpressionsLessonSeeder::class => 24,
                ],
                'links_seeder' => PresentPerfectTimeExpressionsTheoryLinksSeeder::class,
            ],
        ];
    }
    ...
    private function assertAuditReportsPresentPerfectRoutesAsOk(): void
    {
        $jsonPath = storage_path('framework/testing/present-perfect-theory-links-audit.json');
        $markdownPath = storage_path('framework/testing/present-perfect-theory-links-audit.md');
