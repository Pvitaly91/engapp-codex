    ...
    public function mixed_mode_calls_chatgpt_with_random_model(): void
    {
        ...
        $this->mock(GeminiService::class, function ($mock) {
            $mock->shouldReceive('generateGrammarQuestion')
                ->once()
                ->andReturn(['question' => 'First {a1}.', 'answers' => ['a1' => 'one'], 'verb_hints' => [], 'level' => 'B1', 'generated_at' => '2025-01-01T00:00:00Z']);
        ...
        $this->mock(ChatGPTService::class, function ($mock) {
            $mock->shouldReceive('generateGrammarQuestion')
                ...
                ->andReturn(['question' => 'Second {a1}.', 'model' => 'gpt-5', 'answers' => ['a1' => 'two'], 'verb_hints' => [], 'level' => 'B2', 'generated_at' => '2025-01-01T00:00:00Z']);
            $mock->shouldReceive('explainWrongAnswer')->andReturn('x');
        });
