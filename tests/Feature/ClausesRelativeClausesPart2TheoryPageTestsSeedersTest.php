...
use Database\Seeders\Page_V3\ClausesAndLinkingWords\RelativeClausesWithWhoseAndWhichTheorySeeder;
use Database\Seeders\V3\ClausesAndLinkingWords\RelativeClausesAllLevelsV3Seeder;
use Database\Seeders\V3\ClausesAndLinkingWords\RelativeClausesWithWhoseAndWhichAllLevelsV3Seeder;
use Database\Seeders\V3\Polyglot\PolyglotRelativeClausesAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotRelativeClausesLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotRelativeClausesWithWhoseAndWhichAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotRelativeClausesWithWhoseAndWhichB2LessonSeeder;
use Database\Seeders\V3\TheoryLinks\RelativeClausesTheoryLinksSeeder;
use Database\Seeders\V3\TheoryLinks\RelativeClausesWithWhoseAndWhichTheoryLinksSeeder;
...
class ClausesRelativeClausesPart2TheoryPageTestsSeedersTest extends TestCase
{
    ...
    public function test_clauses_relative_clauses_pages_have_tests_and_theory_links(): void
    {
        $this->seedClausesRelativeClausesStack();

        $this->seed([
            RelativeClausesTheoryLinksSeeder::class,
            RelativeClausesWithWhoseAndWhichTheoryLinksSeeder::class,
        ]);
        ...
        $this->assertAuditReportsClausesRelativeClauseRoutesAsOk();
    }

    private function seedClausesRelativeClausesStack(): void
    {
        $this->seed([
            ClausesAndLinkingWordsCategorySeeder::class,
            ClausesAndLinkingWordsRelativeClausesTheorySeeder::class,
            RelativeClausesWithWhoseAndWhichTheorySeeder::class,
            RelativeClausesAllLevelsV3Seeder::class,
            RelativeClausesWithWhoseAndWhichAllLevelsV3Seeder::class,
            PolyglotRelativeClausesAllLevelsLessonSeeder::class,
            PolyglotRelativeClausesWithWhoseAndWhichAllLevelsLessonSeeder::class,
            PolyglotRelativeClausesLessonSeeder::class,
            PolyglotRelativeClausesWithWhoseAndWhichB2LessonSeeder::class,
        ]);
    }
    ...
    private function cases(): array
    {
        return [
            'relative-clauses' => [
                'route' => '/theory/clauses-and-linking-words/relative-clauses',
                'page_slug' => 'relative-clauses',
                'direct_slug' => 'polyglot-relative-clauses-all-levels',
                'v3_seeder' => RelativeClausesAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotRelativeClausesAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [RelativeClausesAllLevelsV3Seeder::class, PolyglotRelativeClausesAllLevelsLessonSeeder::class],
                'covered_seeders' => [RelativeClausesAllLevelsV3Seeder::class, PolyglotRelativeClausesAllLevelsLessonSeeder::class, PolyglotRelativeClausesLessonSeeder::class],
                'links_seeder' => RelativeClausesTheoryLinksSeeder::class,
                'covered_seeder_counts' => [PolyglotRelativeClausesLessonSeeder::class => 24],
            ],
            'relative-clauses-with-whose-and-which' => [
                'route' => '/theory/clauses-and-linking-words/relative-clauses-with-whose-and-which',
                'page_slug' => 'relative-clauses-with-whose-and-which',
                'direct_slug' => 'polyglot-relative-clauses-with-whose-and-which-all-levels',
                'v3_seeder' => RelativeClausesWithWhoseAndWhichAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotRelativeClausesWithWhoseAndWhichAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [RelativeClausesWithWhoseAndWhichAllLevelsV3Seeder::class, PolyglotRelativeClausesWithWhoseAndWhichAllLevelsLessonSeeder::class],
                'covered_seeders' => [RelativeClausesWithWhoseAndWhichAllLevelsV3Seeder::class, PolyglotRelativeClausesWithWhoseAndWhichAllLevelsLessonSeeder::class, PolyglotRelativeClausesWithWhoseAndWhichB2LessonSeeder::class],
                'links_seeder' => RelativeClausesWithWhoseAndWhichTheoryLinksSeeder::class,
                'covered_seeder_counts' => [PolyglotRelativeClausesWithWhoseAndWhichB2LessonSeeder::class => 48],
            ],
        ];
    }
    ...
    private function assertAuditReportsClausesRelativeClauseRoutesAsOk(): void
    {
        $jsonPath = storage_path('framework/testing/clauses-relative-clauses-part2-theory-links-audit.json');
        $markdownPath = storage_path('framework/testing/clauses-relative-clauses-part2-theory-links-audit.md');
