...
use Database\Seeders\Page_V3\Conditionals\ConditionalsUnlessProvidedAsLongAsTheorySeeder;
use Database\Seeders\Page_V3\Conditionals\ConditionalsInCaseTheorySeeder;
use Database\Seeders\Page_V3\Conditionals\ConditionalsWishIfOnlyTheorySeeder;
use Database\Seeders\Page_V3\Conditionals\ConditionalsWouldRatherTheorySeeder;
use Database\Seeders\Page_V3\Conditionals\ConditionalsHadBetterTheorySeeder;
use Database\Seeders\V3\Conditionals\UnlessProvidedAsLongAsAllLevelsV3Seeder;
use Database\Seeders\V3\Conditionals\InCaseAllLevelsV3Seeder;
use Database\Seeders\V3\Conditionals\WishIfOnlyAllLevelsV3Seeder;
use Database\Seeders\V3\Conditionals\WouldRatherAllLevelsV3Seeder;
use Database\Seeders\V3\Conditionals\HadBetterAllLevelsV3Seeder;
use Database\Seeders\V3\Polyglot\PolyglotUnlessProvidedAsLongAsAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotInCaseAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotWishIfOnlyAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotWouldRatherAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotHadBetterAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotWishIfOnlyBasicsLessonSeeder;
use Database\Seeders\V3\TheoryLinks\UnlessProvidedAsLongAsTheoryLinksSeeder;
use Database\Seeders\V3\TheoryLinks\InCaseTheoryLinksSeeder;
use Database\Seeders\V3\TheoryLinks\WishIfOnlyTheoryLinksSeeder;
use Database\Seeders\V3\TheoryLinks\WouldRatherTheoryLinksSeeder;
use Database\Seeders\V3\TheoryLinks\HadBetterTheoryLinksSeeder;
...
class ConditionalsExtraTheoryPageTestsSeedersTest extends TestCase
{
    ...
    public function test_conditionals_extra_pages_have_tests_and_theory_links(): void
    {
        $this->seedConditionalsExtraStack();

        $this->seed([
            UnlessProvidedAsLongAsTheoryLinksSeeder::class,
            InCaseTheoryLinksSeeder::class,
            WishIfOnlyTheoryLinksSeeder::class,
            WouldRatherTheoryLinksSeeder::class,
            HadBetterTheoryLinksSeeder::class,
        ]);
        ...
        $this->assertAuditReportsConditionalsExtraRoutesAsOk();
    }

    private function seedConditionalsExtraStack(): void
    {
        $this->seed([
            ConditionalsCategorySeeder::class,
            ConditionalsUnlessProvidedAsLongAsTheorySeeder::class,
            ConditionalsInCaseTheorySeeder::class,
            ConditionalsWishIfOnlyTheorySeeder::class,
            ConditionalsWouldRatherTheorySeeder::class,
            ConditionalsHadBetterTheorySeeder::class,
            UnlessProvidedAsLongAsAllLevelsV3Seeder::class,
            InCaseAllLevelsV3Seeder::class,
            WishIfOnlyAllLevelsV3Seeder::class,
            WouldRatherAllLevelsV3Seeder::class,
            HadBetterAllLevelsV3Seeder::class,
            PolyglotUnlessProvidedAsLongAsAllLevelsLessonSeeder::class,
            PolyglotInCaseAllLevelsLessonSeeder::class,
            PolyglotWishIfOnlyAllLevelsLessonSeeder::class,
            PolyglotWouldRatherAllLevelsLessonSeeder::class,
            PolyglotHadBetterAllLevelsLessonSeeder::class,
            PolyglotWishIfOnlyBasicsLessonSeeder::class,
        ]);
    }
    ...
    private function cases(): array
    {
        return [
            'unless-provided-as-long-as' => [
                'route' => '/theory/conditionals/unless-provided-as-long-as',
                'page_slug' => 'unless-provided-as-long-as',
                'direct_slug' => 'polyglot-unless-provided-as-long-as-all-levels',
                'v3_seeder' => UnlessProvidedAsLongAsAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotUnlessProvidedAsLongAsAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [UnlessProvidedAsLongAsAllLevelsV3Seeder::class, PolyglotUnlessProvidedAsLongAsAllLevelsLessonSeeder::class],
                'covered_seeders' => [UnlessProvidedAsLongAsAllLevelsV3Seeder::class, PolyglotUnlessProvidedAsLongAsAllLevelsLessonSeeder::class],
                'links_seeder' => UnlessProvidedAsLongAsTheoryLinksSeeder::class,
            ],
            'in-case' => [
                'route' => '/theory/conditionals/in-case',
                'page_slug' => 'in-case',
                'direct_slug' => 'polyglot-in-case-all-levels',
                'v3_seeder' => InCaseAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotInCaseAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [InCaseAllLevelsV3Seeder::class, PolyglotInCaseAllLevelsLessonSeeder::class],
                'covered_seeders' => [InCaseAllLevelsV3Seeder::class, PolyglotInCaseAllLevelsLessonSeeder::class],
                'links_seeder' => InCaseTheoryLinksSeeder::class,
            ],
            'wish-if-only' => [
                'route' => '/theory/conditionals/wish-if-only',
                'page_slug' => 'wish-if-only',
                'direct_slug' => 'polyglot-wish-if-only-all-levels',
                'v3_seeder' => WishIfOnlyAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotWishIfOnlyAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [WishIfOnlyAllLevelsV3Seeder::class, PolyglotWishIfOnlyAllLevelsLessonSeeder::class],
                'covered_seeders' => [WishIfOnlyAllLevelsV3Seeder::class, PolyglotWishIfOnlyAllLevelsLessonSeeder::class, PolyglotWishIfOnlyBasicsLessonSeeder::class],
                'links_seeder' => WishIfOnlyTheoryLinksSeeder::class,
                'covered_seeder_counts' => [PolyglotWishIfOnlyBasicsLessonSeeder::class => 48],
            ],
            'would-rather' => [
                'route' => '/theory/conditionals/would-rather',
                'page_slug' => 'would-rather',
                'direct_slug' => 'polyglot-would-rather-all-levels',
                'v3_seeder' => WouldRatherAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotWouldRatherAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [WouldRatherAllLevelsV3Seeder::class, PolyglotWouldRatherAllLevelsLessonSeeder::class],
                'covered_seeders' => [WouldRatherAllLevelsV3Seeder::class, PolyglotWouldRatherAllLevelsLessonSeeder::class],
                'links_seeder' => WouldRatherTheoryLinksSeeder::class,
            ],
            'had-better' => [
                'route' => '/theory/conditionals/had-better',
                'page_slug' => 'had-better',
                'direct_slug' => 'polyglot-had-better-all-levels',
                'v3_seeder' => HadBetterAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotHadBetterAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [HadBetterAllLevelsV3Seeder::class, PolyglotHadBetterAllLevelsLessonSeeder::class],
                'covered_seeders' => [HadBetterAllLevelsV3Seeder::class, PolyglotHadBetterAllLevelsLessonSeeder::class],
                'links_seeder' => HadBetterTheoryLinksSeeder::class,
            ],
        ];
    }
    ...
    private function assertAuditReportsConditionalsExtraRoutesAsOk(): void
    {
        $jsonPath = storage_path('framework/testing/conditionals-extra-theory-links-audit.json');
        $markdownPath = storage_path('framework/testing/conditionals-extra-theory-links-audit.md');
