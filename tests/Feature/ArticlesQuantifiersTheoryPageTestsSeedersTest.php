...
use Database\Seeders\Page_V3\ArticlesAndQuantifiers\AdvancedArticleAndQuantifierNuanceTheorySeeder;
use Database\Seeders\Page_V3\ArticlesAndQuantifiers\PrecisionWithArticlesAndDeterminersTheorySeeder;
use Database\Seeders\V3\ArticlesAndQuantifiers\AdvancedArticleAndQuantifierNuanceAllLevelsV3Seeder;
use Database\Seeders\V3\ArticlesAndQuantifiers\PrecisionWithArticlesAndDeterminersAllLevelsV3Seeder;
use Database\Seeders\V3\Polyglot\PolyglotAdvancedArticleAndQuantifierNuanceAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotAdvancedArticleAndQuantifierNuanceC1LessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotPrecisionWithArticlesAndDeterminersAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotPrecisionWithArticlesAndDeterminersC2LessonSeeder;
use Database\Seeders\V3\TheoryLinks\AdvancedArticleAndQuantifierNuanceTheoryLinksSeeder;
use Database\Seeders\V3\TheoryLinks\PrecisionWithArticlesAndDeterminersTheoryLinksSeeder;
...
class ArticlesQuantifiersTheoryPageTestsSeedersTest extends TestCase
{
    ...
    public function test_articles_quantifiers_tail_pages_have_tests_and_theory_links(): void
    {
        $this->seedArticlesQuantifiersStack();

        $this->seed([
            AdvancedArticleAndQuantifierNuanceTheoryLinksSeeder::class,
            PrecisionWithArticlesAndDeterminersTheoryLinksSeeder::class,
        ]);
        ...
        foreach ($this->cases() as $caseName => $case) {
            ...
            $this->assertSame('articles-and-quantifiers', $page->category?->slug, $caseName . ': category slug.');
            ...
            $this->assertSame('articles-and-quantifiers', data_get($promptGenerator, 'theory_page.category_slug_path'), $caseName . ': mixed prompt generator category.');
        ...
        $this->assertAuditReportsArticlesQuantifiersRoutesAsOk();
    }

    private function seedArticlesQuantifiersStack(): void
    {
        // There is no separate Page_V3 ArticlesAndQuantifiers category seeder in this repo;
        // these page seeders define/use the articles-and-quantifiers category directly.
        $this->seed([
            AdvancedArticleAndQuantifierNuanceTheorySeeder::class,
            PrecisionWithArticlesAndDeterminersTheorySeeder::class,
            AdvancedArticleAndQuantifierNuanceAllLevelsV3Seeder::class,
            PrecisionWithArticlesAndDeterminersAllLevelsV3Seeder::class,
            PolyglotAdvancedArticleAndQuantifierNuanceAllLevelsLessonSeeder::class,
            PolyglotPrecisionWithArticlesAndDeterminersAllLevelsLessonSeeder::class,
            PolyglotAdvancedArticleAndQuantifierNuanceC1LessonSeeder::class,
            PolyglotPrecisionWithArticlesAndDeterminersC2LessonSeeder::class,
        ]);
    }
    ...
    private function cases(): array
    {
        return [
            'advanced-article-and-quantifier-nuance' => [
                'route' => '/theory/articles-and-quantifiers/advanced-article-and-quantifier-nuance',
                'page_slug' => 'advanced-article-and-quantifier-nuance',
                'direct_slug' => 'polyglot-advanced-article-and-quantifier-nuance-all-levels',
                'v3_seeder' => AdvancedArticleAndQuantifierNuanceAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotAdvancedArticleAndQuantifierNuanceAllLevelsLessonSeeder::class,
                'legacy_seeder' => PolyglotAdvancedArticleAndQuantifierNuanceC1LessonSeeder::class,
                'mixed_filter_seeders' => [AdvancedArticleAndQuantifierNuanceAllLevelsV3Seeder::class, PolyglotAdvancedArticleAndQuantifierNuanceAllLevelsLessonSeeder::class],
                'covered_seeders' => [AdvancedArticleAndQuantifierNuanceAllLevelsV3Seeder::class, PolyglotAdvancedArticleAndQuantifierNuanceAllLevelsLessonSeeder::class, PolyglotAdvancedArticleAndQuantifierNuanceC1LessonSeeder::class],
                'links_seeder' => AdvancedArticleAndQuantifierNuanceTheoryLinksSeeder::class,
                'covered_seeder_counts' => [PolyglotAdvancedArticleAndQuantifierNuanceC1LessonSeeder::class => 48],
                'expected_pivot_rows' => 384,
            ],
            'precision-with-articles-and-determiners' => [
                'route' => '/theory/articles-and-quantifiers/precision-with-articles-and-determiners',
                'page_slug' => 'precision-with-articles-and-determiners',
                'direct_slug' => 'polyglot-precision-with-articles-and-determiners-all-levels',
                'v3_seeder' => PrecisionWithArticlesAndDeterminersAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotPrecisionWithArticlesAndDeterminersAllLevelsLessonSeeder::class,
                'legacy_seeder' => PolyglotPrecisionWithArticlesAndDeterminersC2LessonSeeder::class,
                'mixed_filter_seeders' => [PrecisionWithArticlesAndDeterminersAllLevelsV3Seeder::class, PolyglotPrecisionWithArticlesAndDeterminersAllLevelsLessonSeeder::class],
                'covered_seeders' => [PrecisionWithArticlesAndDeterminersAllLevelsV3Seeder::class, PolyglotPrecisionWithArticlesAndDeterminersAllLevelsLessonSeeder::class, PolyglotPrecisionWithArticlesAndDeterminersC2LessonSeeder::class],
                'links_seeder' => PrecisionWithArticlesAndDeterminersTheoryLinksSeeder::class,
                'covered_seeder_counts' => [PolyglotPrecisionWithArticlesAndDeterminersC2LessonSeeder::class => 48],
                'expected_pivot_rows' => 384,
            ],
        ];
    }
    ...
    private function assertAuditReportsArticlesQuantifiersRoutesAsOk(): void
    {
        $jsonPath = storage_path('framework/testing/articles-quantifiers-theory-links-audit.json');
        $markdownPath = storage_path('framework/testing/articles-quantifiers-theory-links-audit.md');
