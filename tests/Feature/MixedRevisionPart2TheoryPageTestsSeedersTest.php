...
use Database\Seeders\Page_V3\BasicGrammar\BasicGrammarB1MixedRevisionTheorySeeder;
use Database\Seeders\Page_V3\MixedRevision\MixedRevisionCategorySeeder;
use Database\Seeders\V3\MixedRevision\A1MixedRevisionAllLevelsV3Seeder;
use Database\Seeders\V3\MixedRevision\A2MixedRevisionAllLevelsV3Seeder;
use Database\Seeders\V3\MixedRevision\B1MixedRevisionAllLevelsV3Seeder;
use Database\Seeders\V3\Polyglot\PolyglotA1MixedRevisionAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotA2MixedRevisionAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotB1MixedRevisionAllLevelsLessonSeeder;
...
use Database\Seeders\V3\Polyglot\PolyglotFinalDrillB1LessonSeeder;
use Database\Seeders\V3\TheoryLinks\A1MixedRevisionTheoryLinksSeeder;
use Database\Seeders\V3\TheoryLinks\A2MixedRevisionTheoryLinksSeeder;
use Database\Seeders\V3\TheoryLinks\B1MixedRevisionTheoryLinksSeeder;
...
class MixedRevisionPart2TheoryPageTestsSeedersTest extends TestCase
{
    ...
    public function test_a1_a2_b1_mixed_revision_pages_have_tests_and_theory_links(): void
    {
        $this->seedMixedRevisionPart2Stack();

        $this->seed([
            A1MixedRevisionTheoryLinksSeeder::class,
            A2MixedRevisionTheoryLinksSeeder::class,
            B1MixedRevisionTheoryLinksSeeder::class,
        ]);
        ...
        $this->assertAuditReportsMixedRevisionPart2RoutesAsOk();
    }

    private function seedMixedRevisionPart2Stack(): void
    {
        $this->seed([
            MixedRevisionCategorySeeder::class,
            BasicGrammarA1MixedRevisionTheorySeeder::class,
            BasicGrammarA2MixedRevisionTheorySeeder::class,
            BasicGrammarB1MixedRevisionTheorySeeder::class,
            A1MixedRevisionAllLevelsV3Seeder::class,
            A2MixedRevisionAllLevelsV3Seeder::class,
            B1MixedRevisionAllLevelsV3Seeder::class,
            PolyglotA1MixedRevisionAllLevelsLessonSeeder::class,
            PolyglotA2MixedRevisionAllLevelsLessonSeeder::class,
            PolyglotB1MixedRevisionAllLevelsLessonSeeder::class,
            PolyglotFinalDrillLessonSeeder::class,
            PolyglotFinalDrillA2LessonSeeder::class,
            PolyglotFinalDrillB1LessonSeeder::class,
        ]);
    }
    ...
    private function cases(): array
    {
        return [
            'a1-mixed-revision' => [
                'route' => '/theory/mixed-revision/a1-mixed-revision',
                'page_slug' => 'a1-mixed-revision',
                'direct_slug' => 'polyglot-a1-mixed-revision-all-levels',
                'v3_seeder' => A1MixedRevisionAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotA1MixedRevisionAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [A1MixedRevisionAllLevelsV3Seeder::class, PolyglotA1MixedRevisionAllLevelsLessonSeeder::class],
                'covered_seeders' => [A1MixedRevisionAllLevelsV3Seeder::class, PolyglotA1MixedRevisionAllLevelsLessonSeeder::class, PolyglotFinalDrillLessonSeeder::class],
                'links_seeder' => A1MixedRevisionTheoryLinksSeeder::class,
                'covered_seeder_counts' => [PolyglotFinalDrillLessonSeeder::class => 24],
            ],
            'a2-mixed-revision' => [
                'route' => '/theory/mixed-revision/a2-mixed-revision',
                'page_slug' => 'a2-mixed-revision',
                'direct_slug' => 'polyglot-a2-mixed-revision-all-levels',
                'v3_seeder' => A2MixedRevisionAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotA2MixedRevisionAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [A2MixedRevisionAllLevelsV3Seeder::class, PolyglotA2MixedRevisionAllLevelsLessonSeeder::class],
                'covered_seeders' => [A2MixedRevisionAllLevelsV3Seeder::class, PolyglotA2MixedRevisionAllLevelsLessonSeeder::class, PolyglotFinalDrillA2LessonSeeder::class],
                'links_seeder' => A2MixedRevisionTheoryLinksSeeder::class,
                'covered_seeder_counts' => [PolyglotFinalDrillA2LessonSeeder::class => 24],
            ],
            'b1-mixed-revision' => [
                'route' => '/theory/mixed-revision/b1-mixed-revision',
                'page_slug' => 'b1-mixed-revision',
                'direct_slug' => 'polyglot-b1-mixed-revision-all-levels',
                'v3_seeder' => B1MixedRevisionAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotB1MixedRevisionAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [B1MixedRevisionAllLevelsV3Seeder::class, PolyglotB1MixedRevisionAllLevelsLessonSeeder::class],
                'covered_seeders' => [B1MixedRevisionAllLevelsV3Seeder::class, PolyglotB1MixedRevisionAllLevelsLessonSeeder::class, PolyglotFinalDrillB1LessonSeeder::class],
                'links_seeder' => B1MixedRevisionTheoryLinksSeeder::class,
                'covered_seeder_counts' => [PolyglotFinalDrillB1LessonSeeder::class => 48],
            ],
        ];
    }
    ...
    private function assertAuditReportsMixedRevisionPart2RoutesAsOk(): void
    {
        $jsonPath = storage_path('framework/testing/mixed-revision-part2-theory-links-audit.json');
        $markdownPath = storage_path('framework/testing/mixed-revision-part2-theory-links-audit.md');
