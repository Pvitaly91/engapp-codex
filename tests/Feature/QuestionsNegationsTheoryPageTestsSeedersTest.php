...
use Database\Seeders\Page_V3\QuestionsNegations\QuestionsNegationsQuestionFormsTheorySeeder;
use Database\Seeders\Page_V3\QuestionsNegations\TypesOfQuestions\TypesOfQuestionsCategorySeeder;
use Database\Seeders\Page_V3\QuestionsNegations\TypesOfQuestions\TypesOfQuestionsSubjectQuestionsTheorySeeder;
use Database\Seeders\Page_V3\QuestionsNegations\TypesOfQuestions\TypesOfQuestionsWhQuestionsSpecialQuestionsTheorySeeder;
use Database\Seeders\Page_V3\QuestionsNegations\TypesOfQuestions\TypesOfQuestionsYesNoQuestionsGeneralQuestionsTheorySeeder;
use Database\Seeders\V3\Polyglot\PolyglotQuestionFormsAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotSubjectQuestionsAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotWhQuestionsSpecialQuestionsAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotYesNoQuestionsGeneralQuestionsAllLevelsLessonSeeder;
use Database\Seeders\V3\QuestionsNegations\QuestionFormsAllLevelsV3Seeder;
use Database\Seeders\V3\QuestionsNegations\SubjectQuestionsAllLevelsV3Seeder;
use Database\Seeders\V3\QuestionsNegations\WhQuestionsSpecialQuestionsAllLevelsV3Seeder;
use Database\Seeders\V3\QuestionsNegations\YesNoQuestionsGeneralQuestionsAllLevelsV3Seeder;
use Database\Seeders\V3\TheoryLinks\QuestionFormsTheoryLinksSeeder;
use Database\Seeders\V3\TheoryLinks\SubjectQuestionsTheoryLinksSeeder;
use Database\Seeders\V3\TheoryLinks\WhQuestionsSpecialQuestionsTheoryLinksSeeder;
use Database\Seeders\V3\TheoryLinks\YesNoQuestionsGeneralQuestionsTheoryLinksSeeder;
...
class QuestionsNegationsTheoryPageTestsSeedersTest extends TestCase
{
    ...
    public function test_questions_negations_pages_have_tests_and_theory_links(): void
    {
        $this->seedQuestionsNegationsStack();

        $this->seed([
            QuestionFormsTheoryLinksSeeder::class,
            YesNoQuestionsGeneralQuestionsTheoryLinksSeeder::class,
            WhQuestionsSpecialQuestionsTheoryLinksSeeder::class,
            SubjectQuestionsTheoryLinksSeeder::class,
        ]);
        ...
        $this->assertAuditReportsQuestionsNegationsRoutesAsOk();
    }

    private function seedQuestionsNegationsStack(): void
    {
        $this->seed([
            QuestionsNegationsCategorySeeder::class,
            TypesOfQuestionsCategorySeeder::class,
            QuestionsNegationsQuestionFormsTheorySeeder::class,
            ...
            TypesOfQuestionsSubjectQuestionsTheorySeeder::class,
            QuestionFormsAllLevelsV3Seeder::class,
            YesNoQuestionsGeneralQuestionsAllLevelsV3Seeder::class,
            WhQuestionsSpecialQuestionsAllLevelsV3Seeder::class,
            SubjectQuestionsAllLevelsV3Seeder::class,
            PolyglotQuestionFormsAllLevelsLessonSeeder::class,
            PolyglotYesNoQuestionsGeneralQuestionsAllLevelsLessonSeeder::class,
            PolyglotWhQuestionsSpecialQuestionsAllLevelsLessonSeeder::class,
            PolyglotSubjectQuestionsAllLevelsLessonSeeder::class,
        ]);
    }
    ...
    private function cases(): array
    {
        return [
            'question-forms' => [
                'route' => '/theory/pytalni-rechennia-ta-zaperechennia/question-forms',
                'page_slug' => 'question-forms',
                'direct_slug' => 'polyglot-question-forms-all-levels',
                'v3_seeder' => QuestionFormsAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotQuestionFormsAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [QuestionFormsAllLevelsV3Seeder::class, PolyglotQuestionFormsAllLevelsLessonSeeder::class],
                'covered_seeders' => [QuestionFormsAllLevelsV3Seeder::class, PolyglotQuestionFormsAllLevelsLessonSeeder::class],
                'links_seeder' => QuestionFormsTheoryLinksSeeder::class,
            ],
            'yesno-questions-general-questions' => [
                'route' => '/theory/pytalni-rechennia-ta-zaperechennia/types-of-questions/yesno-questions-general-questions',
                'page_slug' => 'yesno-questions-general-questions',
                'direct_slug' => 'polyglot-yes-no-questions-general-questions-all-levels',
                'v3_seeder' => YesNoQuestionsGeneralQuestionsAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotYesNoQuestionsGeneralQuestionsAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [YesNoQuestionsGeneralQuestionsAllLevelsV3Seeder::class, PolyglotYesNoQuestionsGeneralQuestionsAllLevelsLessonSeeder::class],
                'covered_seeders' => [YesNoQuestionsGeneralQuestionsAllLevelsV3Seeder::class, PolyglotYesNoQuestionsGeneralQuestionsAllLevelsLessonSeeder::class],
                'links_seeder' => YesNoQuestionsGeneralQuestionsTheoryLinksSeeder::class,
            ],
            'wh-questions-special-questions-who-what-where-when-why-how' => [
                'route' => '/theory/pytalni-rechennia-ta-zaperechennia/types-of-questions/wh-questions-special-questions-who-what-where-when-why-how',
                'page_slug' => 'wh-questions-special-questions-who-what-where-when-why-how',
                'direct_slug' => 'polyglot-wh-questions-special-questions-all-levels',
                'v3_seeder' => WhQuestionsSpecialQuestionsAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotWhQuestionsSpecialQuestionsAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [WhQuestionsSpecialQuestionsAllLevelsV3Seeder::class, PolyglotWhQuestionsSpecialQuestionsAllLevelsLessonSeeder::class],
                'covered_seeders' => [WhQuestionsSpecialQuestionsAllLevelsV3Seeder::class, PolyglotWhQuestionsSpecialQuestionsAllLevelsLessonSeeder::class],
                'links_seeder' => WhQuestionsSpecialQuestionsTheoryLinksSeeder::class,
            ],
            'subject-questions' => [
                'route' => '/theory/pytalni-rechennia-ta-zaperechennia/types-of-questions/subject-questions',
                'page_slug' => 'subject-questions',
                'direct_slug' => 'polyglot-subject-questions-all-levels',
                'v3_seeder' => SubjectQuestionsAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotSubjectQuestionsAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [SubjectQuestionsAllLevelsV3Seeder::class, PolyglotSubjectQuestionsAllLevelsLessonSeeder::class],
                'covered_seeders' => [SubjectQuestionsAllLevelsV3Seeder::class, PolyglotSubjectQuestionsAllLevelsLessonSeeder::class],
                'links_seeder' => SubjectQuestionsTheoryLinksSeeder::class,
            ],
        ];
    }
    ...
    private function assertAuditReportsQuestionsNegationsRoutesAsOk(): void
    {
        $jsonPath = storage_path('framework/testing/questions-negations-theory-links-audit.json');
        $markdownPath = storage_path('framework/testing/questions-negations-theory-links-audit.md');
