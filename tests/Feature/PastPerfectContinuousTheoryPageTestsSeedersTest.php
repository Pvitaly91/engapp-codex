...
use Database\Seeders\Page_V3\Tenses\PastPerfectContinuous\PastPerfectContinuousCategorySeeder;
use Database\Seeders\Page_V3\Tenses\PastPerfectContinuous\PastPerfectContinuousFormsTheorySeeder;
use Database\Seeders\Page_V3\Tenses\PastPerfectContinuous\PastPerfectContinuousNegativesTheorySeeder;
use Database\Seeders\Page_V3\Tenses\PastPerfectContinuous\PastPerfectContinuousQuestionsTheorySeeder;
use Database\Seeders\Page_V3\Tenses\PastPerfectContinuous\PastPerfectContinuousTimeExpressionsTheorySeeder;
use Database\Seeders\Page_V3\Tenses\TensesCategorySeeder;
use Database\Seeders\V3\Polyglot\PolyglotPastPerfectContinuousBasicsB2LessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotPastPerfectContinuousFormsAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotPastPerfectContinuousNegativesAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotPastPerfectContinuousQuestionsAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotPastPerfectContinuousTimeExpressionsAllLevelsLessonSeeder;
use Database\Seeders\V3\Tenses\PastPerfectContinuous\PastPerfectContinuousFormsAllLevelsV3Seeder;
use Database\Seeders\V3\Tenses\PastPerfectContinuous\PastPerfectContinuousNegativesAllLevelsV3Seeder;
use Database\Seeders\V3\Tenses\PastPerfectContinuous\PastPerfectContinuousQuestionsAllLevelsV3Seeder;
use Database\Seeders\V3\Tenses\PastPerfectContinuous\PastPerfectContinuousTimeExpressionsAllLevelsV3Seeder;
use Database\Seeders\V3\TheoryLinks\PastPerfectContinuousFormsTheoryLinksSeeder;
use Database\Seeders\V3\TheoryLinks\PastPerfectContinuousNegativesTheoryLinksSeeder;
use Database\Seeders\V3\TheoryLinks\PastPerfectContinuousQuestionsTheoryLinksSeeder;
use Database\Seeders\V3\TheoryLinks\PastPerfectContinuousTimeExpressionsTheoryLinksSeeder;
...
class PastPerfectContinuousTheoryPageTestsSeedersTest extends TestCase
{
    ...
    public function test_past_perfect_continuous_pages_have_tests_and_theory_links(): void
    {
        $this->seedPastPerfectContinuousStack();

        $this->seed([
            PastPerfectContinuousFormsTheoryLinksSeeder::class,
            PastPerfectContinuousNegativesTheoryLinksSeeder::class,
            PastPerfectContinuousQuestionsTheoryLinksSeeder::class,
            PastPerfectContinuousTimeExpressionsTheoryLinksSeeder::class,
        ]);
        ...
        $this->assertAuditReportsPastPerfectContinuousRoutesAsOk();
    }

    private function seedPastPerfectContinuousStack(): void
    {
        $this->seed([
            TensesCategorySeeder::class,
            PastPerfectContinuousCategorySeeder::class,
            PastPerfectContinuousFormsTheorySeeder::class,
            PastPerfectContinuousNegativesTheorySeeder::class,
            PastPerfectContinuousQuestionsTheorySeeder::class,
            PastPerfectContinuousTimeExpressionsTheorySeeder::class,
            PastPerfectContinuousFormsAllLevelsV3Seeder::class,
            PastPerfectContinuousNegativesAllLevelsV3Seeder::class,
            PastPerfectContinuousQuestionsAllLevelsV3Seeder::class,
            PastPerfectContinuousTimeExpressionsAllLevelsV3Seeder::class,
            PolyglotPastPerfectContinuousFormsAllLevelsLessonSeeder::class,
            PolyglotPastPerfectContinuousNegativesAllLevelsLessonSeeder::class,
            PolyglotPastPerfectContinuousQuestionsAllLevelsLessonSeeder::class,
            PolyglotPastPerfectContinuousTimeExpressionsAllLevelsLessonSeeder::class,
            PolyglotPastPerfectContinuousBasicsB2LessonSeeder::class,
        ]);
    }
    ...
    private function cases(): array
    {
        return [
            'forms' => [
                'route' => '/theory/tenses/past-perfect-continuous/past-perfect-continuous-forms',
                'page_slug' => 'past-perfect-continuous-forms',
                'direct_slug' => 'polyglot-past-perfect-continuous-forms-all-levels',
                'v3_seeder' => PastPerfectContinuousFormsAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotPastPerfectContinuousFormsAllLevelsLessonSeeder::class,
                ...
                'covered_seeder_counts' => [
                    PastPerfectContinuousFormsAllLevelsV3Seeder::class => 72,
                    PolyglotPastPerfectContinuousFormsAllLevelsLessonSeeder::class => 72,
                    PolyglotPastPerfectContinuousBasicsB2LessonSeeder::class => 48,
                ],
                'links_seeder' => PastPerfectContinuousFormsTheoryLinksSeeder::class,
            ],
            'negatives' => [
                'route' => '/theory/tenses/past-perfect-continuous/past-perfect-continuous-negatives',
                'page_slug' => 'past-perfect-continuous-negatives',
                'direct_slug' => 'polyglot-past-perfect-continuous-negatives-all-levels',
                'v3_seeder' => PastPerfectContinuousNegativesAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotPastPerfectContinuousNegativesAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [
                    PastPerfectContinuousNegativesAllLevelsV3Seeder::class,
                    PolyglotPastPerfectContinuousNegativesAllLevelsLessonSeeder::class,
                ],
                ...
                'links_seeder' => PastPerfectContinuousNegativesTheoryLinksSeeder::class,
            ],
            'questions' => [
                'route' => '/theory/tenses/past-perfect-continuous/past-perfect-continuous-questions',
                'page_slug' => 'past-perfect-continuous-questions',
                'direct_slug' => 'polyglot-past-perfect-continuous-questions-all-levels',
                'v3_seeder' => PastPerfectContinuousQuestionsAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotPastPerfectContinuousQuestionsAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [
                    PastPerfectContinuousQuestionsAllLevelsV3Seeder::class,
                    PolyglotPastPerfectContinuousQuestionsAllLevelsLessonSeeder::class,
                ],
                ...
                'links_seeder' => PastPerfectContinuousQuestionsTheoryLinksSeeder::class,
            ],
            'time_expressions' => [
                'route' => '/theory/tenses/past-perfect-continuous/past-perfect-continuous-time-expressions',
                'page_slug' => 'past-perfect-continuous-time-expressions',
                'direct_slug' => 'polyglot-past-perfect-continuous-time-expressions-all-levels',
                'v3_seeder' => PastPerfectContinuousTimeExpressionsAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotPastPerfectContinuousTimeExpressionsAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [
                    PastPerfectContinuousTimeExpressionsAllLevelsV3Seeder::class,
                    PolyglotPastPerfectContinuousTimeExpressionsAllLevelsLessonSeeder::class,
                ],
                ...
                'links_seeder' => PastPerfectContinuousTimeExpressionsTheoryLinksSeeder::class,
            ],
        ];
    }
    ...
    private function assertAuditReportsPastPerfectContinuousRoutesAsOk(): void
    {
        $jsonPath = storage_path('framework/testing/past-perfect-continuous-theory-links-audit.json');
        $markdownPath = storage_path('framework/testing/past-perfect-continuous-theory-links-audit.md');
