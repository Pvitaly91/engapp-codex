...
use Database\Seeders\Page_V3\VerbPatterns\VerbPatternsGerundTheorySeeder;
use Database\Seeders\Page_V3\VerbPatterns\VerbPatternsToInfinitiveTheorySeeder;
use Database\Seeders\Page_V3\VerbPatterns\VerbPatternsVerbsPlusGerundTheorySeeder;
use Database\Seeders\Page_V3\VerbPatterns\VerbPatternsVerbsPlusInfinitiveTheorySeeder;
use Database\Seeders\V3\Polyglot\PolyglotGerundAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotToInfinitiveAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotVerbsPlusGerundAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotVerbsPlusInfinitiveAllLevelsLessonSeeder;
use Database\Seeders\V3\TheoryLinks\GerundTheoryLinksSeeder;
use Database\Seeders\V3\TheoryLinks\ToInfinitiveTheoryLinksSeeder;
use Database\Seeders\V3\TheoryLinks\VerbsPlusGerundTheoryLinksSeeder;
use Database\Seeders\V3\TheoryLinks\VerbsPlusInfinitiveTheoryLinksSeeder;
use Database\Seeders\V3\VerbPatterns\GerundAllLevelsV3Seeder;
use Database\Seeders\V3\VerbPatterns\ToInfinitiveAllLevelsV3Seeder;
use Database\Seeders\V3\VerbPatterns\VerbsPlusGerundAllLevelsV3Seeder;
use Database\Seeders\V3\VerbPatterns\VerbsPlusInfinitiveAllLevelsV3Seeder;
...
class VerbPatternsTheoryPageTestsSeedersTest extends TestCase
{
    ...
    public function test_verb_patterns_pages_have_tests_and_theory_links(): void
    {
        $this->seedVerbPatternsStack();

        $this->seed([
            ToInfinitiveTheoryLinksSeeder::class,
            GerundTheoryLinksSeeder::class,
            VerbsPlusInfinitiveTheoryLinksSeeder::class,
            VerbsPlusGerundTheoryLinksSeeder::class,
        ]);
        ...
        $this->assertAuditReportsVerbPatternsRoutesAsOk();
    }

    private function seedVerbPatternsStack(): void
    {
        $this->seed([
            VerbPatternsCategorySeeder::class,
            VerbPatternsToInfinitiveTheorySeeder::class,
            VerbPatternsGerundTheorySeeder::class,
            VerbPatternsVerbsPlusInfinitiveTheorySeeder::class,
            VerbPatternsVerbsPlusGerundTheorySeeder::class,
            ToInfinitiveAllLevelsV3Seeder::class,
            GerundAllLevelsV3Seeder::class,
            VerbsPlusInfinitiveAllLevelsV3Seeder::class,
            VerbsPlusGerundAllLevelsV3Seeder::class,
            PolyglotToInfinitiveAllLevelsLessonSeeder::class,
            PolyglotGerundAllLevelsLessonSeeder::class,
            PolyglotVerbsPlusInfinitiveAllLevelsLessonSeeder::class,
            PolyglotVerbsPlusGerundAllLevelsLessonSeeder::class,
        ]);
    }
    ...
    private function cases(): array
    {
        return [
            'to-infinitive' => [
                'route' => '/theory/verb-patterns/to-infinitive',
                'page_slug' => 'to-infinitive',
                'direct_slug' => 'polyglot-to-infinitive-all-levels',
                'v3_seeder' => ToInfinitiveAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotToInfinitiveAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [ToInfinitiveAllLevelsV3Seeder::class, PolyglotToInfinitiveAllLevelsLessonSeeder::class],
                'covered_seeders' => [ToInfinitiveAllLevelsV3Seeder::class, PolyglotToInfinitiveAllLevelsLessonSeeder::class],
                'links_seeder' => ToInfinitiveTheoryLinksSeeder::class,
            ],
            'gerund' => [
                'route' => '/theory/verb-patterns/gerund',
                'page_slug' => 'gerund',
                'direct_slug' => 'polyglot-gerund-all-levels',
                'v3_seeder' => GerundAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotGerundAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [GerundAllLevelsV3Seeder::class, PolyglotGerundAllLevelsLessonSeeder::class],
                'covered_seeders' => [GerundAllLevelsV3Seeder::class, PolyglotGerundAllLevelsLessonSeeder::class],
                'links_seeder' => GerundTheoryLinksSeeder::class,
            ],
            'verbs-plus-infinitive' => [
                'route' => '/theory/verb-patterns/verbs-plus-infinitive',
                'page_slug' => 'verbs-plus-infinitive',
                'direct_slug' => 'polyglot-verbs-plus-infinitive-all-levels',
                'v3_seeder' => VerbsPlusInfinitiveAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotVerbsPlusInfinitiveAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [VerbsPlusInfinitiveAllLevelsV3Seeder::class, PolyglotVerbsPlusInfinitiveAllLevelsLessonSeeder::class],
                'covered_seeders' => [VerbsPlusInfinitiveAllLevelsV3Seeder::class, PolyglotVerbsPlusInfinitiveAllLevelsLessonSeeder::class],
                'links_seeder' => VerbsPlusInfinitiveTheoryLinksSeeder::class,
            ],
            'verbs-plus-gerund' => [
                'route' => '/theory/verb-patterns/verbs-plus-gerund',
                'page_slug' => 'verbs-plus-gerund',
                'direct_slug' => 'polyglot-verbs-plus-gerund-all-levels',
                'v3_seeder' => VerbsPlusGerundAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotVerbsPlusGerundAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [VerbsPlusGerundAllLevelsV3Seeder::class, PolyglotVerbsPlusGerundAllLevelsLessonSeeder::class],
                'covered_seeders' => [VerbsPlusGerundAllLevelsV3Seeder::class, PolyglotVerbsPlusGerundAllLevelsLessonSeeder::class],
                'links_seeder' => VerbsPlusGerundTheoryLinksSeeder::class,
            ],
        ];
    }
    ...
    private function assertAuditReportsVerbPatternsRoutesAsOk(): void
    {
        $jsonPath = storage_path('framework/testing/verb-patterns-theory-links-audit.json');
        $markdownPath = storage_path('framework/testing/verb-patterns-theory-links-audit.md');
