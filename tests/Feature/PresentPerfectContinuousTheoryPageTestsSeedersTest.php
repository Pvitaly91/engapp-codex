...
use Database\Seeders\Page_V3\Tenses\PresentPerfectContinuous\PresentPerfectContinuousNegativesTheorySeeder;
use Database\Seeders\Page_V3\Tenses\PresentPerfectContinuous\PresentPerfectContinuousQuestionsTheorySeeder;
use Database\Seeders\Page_V3\Tenses\PresentPerfectContinuous\PresentPerfectContinuousTimeExpressionsTheorySeeder;
...
use Database\Seeders\V3\Polyglot\PolyglotPresentPerfectContinuousFormsAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotPresentPerfectContinuousNegativesAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotPresentPerfectContinuousQuestionsAllLevelsLessonSeeder;
use Database\Seeders\V3\Polyglot\PolyglotPresentPerfectContinuousTimeExpressionsAllLevelsLessonSeeder;
use Database\Seeders\V3\Tenses\PresentPerfectContinuous\PresentPerfectContinuousFormsAllLevelsV3Seeder;
use Database\Seeders\V3\Tenses\PresentPerfectContinuous\PresentPerfectContinuousNegativesAllLevelsV3Seeder;
use Database\Seeders\V3\Tenses\PresentPerfectContinuous\PresentPerfectContinuousQuestionsAllLevelsV3Seeder;
use Database\Seeders\V3\Tenses\PresentPerfectContinuous\PresentPerfectContinuousTimeExpressionsAllLevelsV3Seeder;
use Database\Seeders\V3\TheoryLinks\PresentPerfectContinuousFormsTheoryLinksSeeder;
use Database\Seeders\V3\TheoryLinks\PresentPerfectContinuousNegativesTheoryLinksSeeder;
use Database\Seeders\V3\TheoryLinks\PresentPerfectContinuousQuestionsTheoryLinksSeeder;
use Database\Seeders\V3\TheoryLinks\PresentPerfectContinuousTimeExpressionsTheoryLinksSeeder;
...
class PresentPerfectContinuousTheoryPageTestsSeedersTest extends TestCase
{
    ...
    public function test_present_perfect_continuous_pages_have_tests_and_theory_links(): void
    {
        $this->seedPresentPerfectContinuousStack();

        $this->seed([
            PresentPerfectContinuousFormsTheoryLinksSeeder::class,
            PresentPerfectContinuousNegativesTheoryLinksSeeder::class,
            PresentPerfectContinuousQuestionsTheoryLinksSeeder::class,
            PresentPerfectContinuousTimeExpressionsTheoryLinksSeeder::class,
        ]);
        ...
        $this->assertAuditReportsPresentPerfectContinuousRoutesAsOk();
    }

    private function seedPresentPerfectContinuousStack(): void
    {
        $this->seed([
            TensesCategorySeeder::class,
            PresentPerfectContinuousCategorySeeder::class,
            PresentPerfectContinuousFormsTheorySeeder::class,
            PresentPerfectContinuousNegativesTheorySeeder::class,
            PresentPerfectContinuousQuestionsTheorySeeder::class,
            PresentPerfectContinuousTimeExpressionsTheorySeeder::class,
            PresentPerfectContinuousFormsAllLevelsV3Seeder::class,
            PresentPerfectContinuousNegativesAllLevelsV3Seeder::class,
            PresentPerfectContinuousQuestionsAllLevelsV3Seeder::class,
            PresentPerfectContinuousTimeExpressionsAllLevelsV3Seeder::class,
            PolyglotPresentPerfectContinuousFormsAllLevelsLessonSeeder::class,
            PolyglotPresentPerfectContinuousNegativesAllLevelsLessonSeeder::class,
            PolyglotPresentPerfectContinuousQuestionsAllLevelsLessonSeeder::class,
            PolyglotPresentPerfectContinuousTimeExpressionsAllLevelsLessonSeeder::class,
            PolyglotPresentPerfectContinuousBasicsLessonSeeder::class,
        ]);
    }
    ...
    private function cases(): array
    {
        return [
            'forms' => [
                'route' => '/theory/tenses/present-perfect-continuous/present-perfect-continuous-forms',
                'page_slug' => 'present-perfect-continuous-forms',
                'direct_slug' => 'polyglot-present-perfect-continuous-forms-all-levels',
                'v3_seeder' => PresentPerfectContinuousFormsAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotPresentPerfectContinuousFormsAllLevelsLessonSeeder::class,
                ...
                'covered_seeder_counts' => [
                    PresentPerfectContinuousFormsAllLevelsV3Seeder::class => 72,
                    PolyglotPresentPerfectContinuousFormsAllLevelsLessonSeeder::class => 72,
                    PolyglotPresentPerfectContinuousBasicsLessonSeeder::class => 24,
                ],
                'links_seeder' => PresentPerfectContinuousFormsTheoryLinksSeeder::class,
            ],
            'negatives' => [
                'route' => '/theory/tenses/present-perfect-continuous/present-perfect-continuous-negatives',
                'page_slug' => 'present-perfect-continuous-negatives',
                'direct_slug' => 'polyglot-present-perfect-continuous-negatives-all-levels',
                'v3_seeder' => PresentPerfectContinuousNegativesAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotPresentPerfectContinuousNegativesAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [
                    PresentPerfectContinuousNegativesAllLevelsV3Seeder::class,
                    PolyglotPresentPerfectContinuousNegativesAllLevelsLessonSeeder::class,
                ],
                ...
                'links_seeder' => PresentPerfectContinuousNegativesTheoryLinksSeeder::class,
            ],
            'questions' => [
                'route' => '/theory/tenses/present-perfect-continuous/present-perfect-continuous-questions',
                'page_slug' => 'present-perfect-continuous-questions',
                'direct_slug' => 'polyglot-present-perfect-continuous-questions-all-levels',
                'v3_seeder' => PresentPerfectContinuousQuestionsAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotPresentPerfectContinuousQuestionsAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [
                    PresentPerfectContinuousQuestionsAllLevelsV3Seeder::class,
                    PolyglotPresentPerfectContinuousQuestionsAllLevelsLessonSeeder::class,
                ],
                ...
                'links_seeder' => PresentPerfectContinuousQuestionsTheoryLinksSeeder::class,
            ],
            'time_expressions' => [
                'route' => '/theory/tenses/present-perfect-continuous/present-perfect-continuous-time-expressions',
                'page_slug' => 'present-perfect-continuous-time-expressions',
                'direct_slug' => 'polyglot-present-perfect-continuous-time-expressions-all-levels',
                'v3_seeder' => PresentPerfectContinuousTimeExpressionsAllLevelsV3Seeder::class,
                'polyglot_seeder' => PolyglotPresentPerfectContinuousTimeExpressionsAllLevelsLessonSeeder::class,
                'mixed_filter_seeders' => [
                    PresentPerfectContinuousTimeExpressionsAllLevelsV3Seeder::class,
                    PolyglotPresentPerfectContinuousTimeExpressionsAllLevelsLessonSeeder::class,
                ],
                ...
                'links_seeder' => PresentPerfectContinuousTimeExpressionsTheoryLinksSeeder::class,
            ],
        ];
    }
    ...
    private function assertAuditReportsPresentPerfectContinuousRoutesAsOk(): void
    {
        $jsonPath = storage_path('framework/testing/present-perfect-continuous-theory-links-audit.json');
        $markdownPath = storage_path('framework/testing/present-perfect-continuous-theory-links-audit.md');
