...
Route::middleware('auth.admin')->group(function () use ($reservedPrefixes) {
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::post('/question-marker-tag/add', [QuestionHelpController::class, 'addMarkerTag'])->name('question.marker-tag.add');
        Route::post('/question-marker-tag/remove', [QuestionHelpController::class, 'removeMarkerTag'])->name('question.marker-tag.remove');
        Route::post('/question-marker-tag/available', [QuestionHelpController::class, 'getPageAvailableTags'])->name('question.marker-tag.available');
