...
Route::get('/words/test/state', [PublicWordsTestController::class, 'state'])->name('public.words.test.state');
Route::post('/words/test/answer', [PublicWordsTestController::class, 'answer'])->name('public.words.test.answer');
