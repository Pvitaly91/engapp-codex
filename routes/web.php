...
Route::middleware('auth.admin')->group(function () use ($reservedPrefixes) {
    ...
    // V2 Test routes with new UI design
    Route::post('/test-v2/{slug}/js/state', [TestJsV2Controller::class, 'storeState'])->name('saved-test-v2.js.state');
    Route::get('/test-v2/{slug}/js/questions', [TestJsV2Controller::class, 'fetchQuestions'])->name('saved-test-v2.js.questions');
    Route::get('/test-v2/{slug}/js', [TestJsV2Controller::class, 'show'])->name('saved-test-v2.js');
