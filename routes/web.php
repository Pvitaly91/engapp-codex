...
Route::middleware('auth.admin')->group(function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::prefix('test-tags')->name('test-tags.')->group(function () {
            ...
            Route::get('/categories/create', [TestTagController::class, 'createCategory'])->name('categories.create');
            Route::post('/categories', [TestTagController::class, 'storeCategory'])->name('categories.store');
