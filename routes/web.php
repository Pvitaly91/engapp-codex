...
Route::middleware('auth.admin')->group(function () use ($reservedPrefixes) {
    ...
    // V2 Test Routes
    Route::get('/test-v2/{slug}/js', [TestJsV2Controller::class, 'show'])->name('saved-test.js.v2');
    Route::get('/test-v2/{slug}/js/questions', [TestJsV2Controller::class, 'fetchQuestions'])->name('saved-test.js.v2.questions');
    Route::post('/test-v2/{slug}/js/state', [TestJsV2Controller::class, 'storeState'])->name('saved-test.js.v2.state');
